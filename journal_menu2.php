                            ...
                            <div id="journal" class="section-journal">
                                <div class="con">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="journal">
                                                <img src="img/journal_bk.png" alt="jou" class="img_fluid">
                                                    <div class="journal-content">  
                                                        <h3 class="title-journal">International Journal</h3>
                                                         <br>
                                                         <button class="btn"  href="javascript:void(0);" 
                                                         onclick="window.location.href='journal_inter_journal.php'">
                                                         Click here 
                                                         </button>
                                                    </div>
                                            </div>
                                                ...
                                                <img src="img/journal_bk.png" alt="jou" class="img_fluid">
                                                    <div class="journal-content">  
                                                        <h3 class="title-journal">National Journal</h3>
                                                         <br>
                                                         <button class="btn"  href="javascript:void(0);" 
                                                         onclick="window.location.href='journal_nat_journal.php'">
                                                         Click here 
                                                         </button>
                                                    </div>
                                            </div>
