<!DOCTYPE html>
    ...
    <?php
        ...
        <link rel="stylesheet" href="css/menu_new_res.css">
        <style>
            body {
                margin: 0
            }
        ...
        <main class="container-fluid">
            <div class="row">
                <nav id="tmSidebar" class="tm-bg-black-transparent tm-sidebar">
                    ...
                    <div class="tm-brand-box">
                        ...
                        <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="javascript:void(0);" 
                                onclick="window.location.href='contact.php'" class="nav-link">
                                    <span class="rect"></span>
                                    <span class="circle"></span>
                                    Contact
                                </a>
                ...
                <main role="main" class="ml-sm-12 col-12">
                    <div class="tm-section-wrap session_back_image">
                        <h2 class="session_heading">Session Chair</h2>

                        <section class="row tm-section">
                            <div id="session" class="section-session">
                                <div class="con">
                                    <div class="row" id="row">
                                        <div class="session">
                                            <img src="img/sess1.png" alt="se" class="img_fluid" id="img1">  
                                                <div class="session-content">
                                                      <h3 class="title-session">International Conferences</h3>
                                                      <button class="btn-sn"  href="javascript:void(0);" 
                                                      onclick="window.location.href='session_inter_conf.php'">
                                                      Click here 
                                                     </button>
                                                </div>
                                        </div>
                                        ...
                                        <div class="session">
                                            <img src="img/sess1.png" alt="se" class="img_fluid" id="img2">
                                                <div class="session-content">
                                                        <h3 class="title-session">National Conferences</h3>
                                                        
                                                        <button class="btn-sn"  href="javascript:void(0);" 
                                                          onclick="window.location.href='session_nat_conf.php'">
                                                         Click here 
                                                        </button>
                                                </div>
                                        </div>
