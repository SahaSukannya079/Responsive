                ...
                <nav id="tmSidebar" class="tm-bg-black-transparent tm-sidebar">
                    ...
                    <div class="tm-brand-box">
                        ...
                        <ul id="tmMainNav" class="nav flex-column text-uppercase text-right tm-main-nav">
                            ...
                            <li class="nav-item">
                                <a href="javascript:void(0);"
                                 onclick="window.location.href='chapter.php'" 
                ...
                <main role="main" class="ml-sm-12 col-12">
                    <div class="tm-section-wrap chapter_back_image">
                                ...
                                <ul class="cha_ul">
                                    ...
                                    $rows = $pdostmt->fetchAll(PDO::FETCH_BOTH);
                                         ...
                                         foreach ($rows as $row) {
                                            ...
                                            if ($row['ISBN'] != "#" && $row['ISBN'] != "none" && $row['ISBN'] != "N/a" && $row['page'] != "N/A") {
                                                echo "<h3 class='cha-con'>"."<b class='cha_title'>ISBN:</b> " . htmlentities($row['ISBN']) . "<br>";
                                            }

                                            if ($row['editor_name'] != "#" && $row['editor_name'] != "none" && $row['editor_name'] != "N/a" && $row['page'] != "N/A") {
                                                echo "<h3 class='cha-con'>"."<b class='cha_title'>Eds:</b> " . htmlentities($row['editor_name']) . "<br>";
                                            }

                                            if ($row['publisher'] != "#" && $row['publisher'] != "none" && $row['publisher'] != "N/a" && $row['page'] != "N/A") {
                        ...
                        <?php
                            ...
                            if ($page >= 2) {
                               echo "<a href='chapter.php?page=" . ($page - 1) . "'>  
                               <i  class='fas'>&#xf053;</i> </a>";
                            }
                            echo "<a class='nice'>";
                            echo $page;
