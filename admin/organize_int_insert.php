...
if (empty($_SESSION['email'])) {
    ...
    if (
        isset($_POST["submit"]) && !empty($_POST["org"])
        && !empty($_POST["pos"])
    ) {
        ...
        try {
            ...
            $stmt = "insert into organizing_inter (organizing_inter_id,admin_id,organization,position) 
            values(' ','$admin_id','$org', '$pos');";
            $conn->exec($stmt);

            echo "<script>window.alert('International Posted to the CMS System Successful!!');</script>";
            echo "<script>window.location.assign('organize_int_action.php');</script>";
            header("Location:../organize_int.php");
            header("Location:organize_int_action.php");
        ...
        <div class="row">
            ...
            <main role="main" class="ml-sm-12 col-12">
                <div class="tm-section-wrap">
                    <h2 class="heading">Organizing Experience  </h2>
                    <h3 class="head2">Insert To International</h3>
                    <br>
                    <br>
                    ...
                    <div class="container-insert">
                        <form action="" method="POST" class="form">
                            <div class="row">
                                ...
                                <div class="col-65">
                                    <input type="text" name="org" placeholder="Enter Organization">
                                </div>
                                <br>
                                <br>
                                <div class="col-25">
