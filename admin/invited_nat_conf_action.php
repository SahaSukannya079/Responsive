        ...
        <main class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="ml-sm-12 col-12">
                    <div class="tm-section-wrap nat_back_image">
                    
                    <h2 class="heading">Invited Speaker</h2>
                    <h3 class="head2">National Conference</h3>

                        <?php
                        require_once "pdo.php";

                        $stmt = $pdo->query("SELECT * FROM nat_conf");
                        ...
                        $stmt = 'SELECT * FROM nat_conf LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
                        ...
                        foreach ($rows as $row) {
                          ...
                          echo    '<div class="col-12 md-5">';
                          echo       '<div class="w-100 tm-double-border-nat1 tm-border-color">';
                          echo          '<div class="tm-double-border-nat2 tm-border-color tm-box-pad-content-nat">';
                          echo             '<div class="text_back">';
                          echo                 " <i class='far'>&#xf0a4;</i> <span class='title'>" . htmlentities($row['title']) . ".\t" . "</span>";
                          echo                 "<b class='bold'>" . htmlentities($row['conf_name']) . ",</b>" . "\t";
                          echo                 "<span class='date'>" . htmlentities($row['date']) . ".</span>";
                          echo               '</div>';
                          echo            '</div>';
                          echo         '</div>';
                          echo      '<br>';
                          ...
                          echo '<div id="wrapper">
                                  <div class="nat-col-40">
                                    <button type="button" class="nat_edit">
                                      <a style="text-decoration: none;color:white;" class=""  
                                        href='."invited_nat_conf_edit.php?value=$row[0]".' target="_blank">Edit
                                      </a>
                                    </button>
                                  </div>
                         
                                  <div class="nat-col-45">
                                    <button type="button" class="nat_del">
                                      <a style="text-decoration: none;color:white;" class="" 
                                        href='."invited_nat_conf_delete.php?del=$row[0]".' target="_blank">Delete
                                      </a>
                                    </button>
                                  </div>
                                </div>';
                        ...
                        <br>
                        <div id="wrapper">
                            <button type="button" class="nat_add_new" >
                              <a style="text-decoration: none;color:white;" 
                                href="invited_nat_conf_insert.php">Add New Conference
                              </a>
                            </button>
                        </div>
                        <br>
                        ...
                        <?php
                          ...
                          if ($page >= 2) {
                            echo "<a href='invited_nat_conf_action.php?page=" . ($page - 1) . "'>  
                            <i  class='fas'>&#xf053;</i></a>";
                          }
