        ...
        <main class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="ml-sm-12 col-12">
                    <div class="tm-section-wrap back_image">
                    
                    <h2 class="heading">Invited Speaker</h2>
                    <h3 class="head2">International Conference</h3>

                        <?php
                        require_once "pdo.php";

                        $stmt = $pdo->query("SELECT * FROM inter_conf");
                        ...
                        $stmt = 'SELECT * FROM inter_conf LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
                        ...
                        foreach ($rows as $row) {
                          ...
                          echo       '<div class="w-100 tm-double-border-s1 tm-border-color">';
                          echo          '<div class="tm-double-border-s2 tm-border-color tm-box-pad-content">';
                          echo             '<div class="text_back"> <i class="far">&#xf0a4;</i> ';

                          if ($row['title']  != "N/A") {
                            echo                 " <span class='title'>" . htmlentities($row['title']) . ".\t" . "</span>";
                          }

                          if ($row['conf_name']  != "N/A") {
                          ...
                          echo '<div id="wrapper">
                                 <div class="col-40">
                                    <button type="button" class="incf_edit">
                                      <a style="text-decoration: none;color:white;" class=""  
                                        href='."invited_inter_conf_edit.php?value=$row[0]".' target="_blank">Edit
                                      </a>
                                    </button>
                                    </div>
                         
                                  <div class="col-45">
                                    <button type="button" class="incf_del">
                                      <a style="text-decoration: none;color:white;" class="" 
                                        href='."invited_inter_conf_delete.php?del=$row[0]".' target="_blank">Delete
                                      </a>
                                    </button>
                                    </div>
                                  </div>';
...
<br>
                        ...
                        <div id="wrapper">
                            <button type="button" class="nat_add_new" >
                              <a style="text-decoration: none;color:white;" 
                                href="invited_inter_conf_insert.php">Add New Conference
                              </a>
                            </button>
                        </div>
                        <br>
                        ...
                        <?php
                          ...
                          if ($page >= 2) {
                            echo "<a href='invited_inter_conf_action.php?page=" . ($page - 1) . "'>  
                            <i  class='fas'>&#xf053;</i></a>";
                          }
                          echo "<a class='nice'>";
                            echo $page;
