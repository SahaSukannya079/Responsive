...
if (empty($_SESSION['email'])) {
  ...
  if (
    isset($_POST["submit"]) && !empty($_POST["book_name"])
    ...
    try {
      ...
      $stmt = "insert into books_edited (book_id,admin_id,book_name,ISBN,author_name,publisher) 
            values(' ','$admin_id','$book_name', '$isbn', '$author_name', '$pub');";
      $conn->exec($stmt);
      ...
      header("Location:../book_edited.php");
      header("Location:book_edited_action.php");
        ...
        <div class="row">
            ...
            <main role="main" class="ml-sm-12 col-12">
                <div class="tm-section-wrap">
                    <h2 class="heading">Insert To Books Edited</h2>
                    <br>
                    <br>
