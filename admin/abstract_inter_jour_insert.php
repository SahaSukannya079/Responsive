...
if (empty($_SESSION['email'])) {
  ...
  if (
    ...
    try {
      ...
      $stmt = "insert into abstract_int_journal (abstract_int_journal_id,admin_id,title,author_name,publication,page) 
            values(' ','$admin_id','$title','$author_name', '$pub', '$page');";
      $conn->exec($stmt);

      echo "<script>window.alert('Books edited Posted to the CMS System Successful!!');</script>";
      echo "<script>window.location.assign('abstract_inter_jour_action.php');</script>";
      
      header("Location:abstract_inter_jour_action.php");
        ...
        <div class="row">
            ...
            <main role="main" class="ml-sm-12 col-12">
                <div class="tm-section-wrap">
                    ...
                    <h3 class="head2">International Journal</h3>
                    <br>
                    <br>
                    ...
                    <div class="container-insert">
                        <form action="" method="POST" class="form">
                            <div class="row">
                                ...
                                <div class="col-65">
                                    <input type="text" name="page" list="pn"
                                    placeholder="Select N/A if you want to leave this field empty">
