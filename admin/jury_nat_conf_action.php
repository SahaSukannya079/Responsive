        ...
        <main class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="ml-sm-12 col-12">
                    <div class="tm-section-wrap jury_nat_back_image">

                   
                    <h2 class="jury_nat_heading">Jury / Moderator / </h2>
                    <h2 class="jury_nat_heading2">Panelist / Resource Person </h2>
                    <h3 class="jury_nat_head2">National Conference</h3>
                         
                        <section class="row tm-section">
                            <div id="jury_nat" class="section-jury_nat">

                                <ul class="jury_nat_ul">
                                    <?php
                                        require_once "pdo.php";

                                        $stmt = $pdo->query("SELECT * FROM jury_nat_conf");
                                        ...
                                        $stmt = 'SELECT * FROM jury_nat_conf LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
                                        ...
                                        $rows = $pdostmt->fetchAll(PDO::FETCH_BOTH);
                                         ...
                                         foreach ($rows as $row) {
                                            ...
                                            echo  '<div class="jury_nat">';
                                            echo  '<img src="../img/jury_nat_back.png" alt="juryn">';
                                            echo  '<div class="jury_nat-content">';
                                            echo   "<i style='font-size:24px' class='far'>&#xf0a4;</i> <span class='jury_nat-title'>" . htmlentities($row['title']) . ".\t" ;
                                            echo   "<span class='jury_nat-conf'>" . "<b>".htmlentities($row['conf_name']) ."</b>". ",\t" . "</span>";
                                            echo   "<b class='jury_nat-date'>" . htmlentities($row['date']) .".\t";
                                          
                                            echo  '<br>'; 

                                            echo '<div id="wrapper">
                                                    <div class="jury_nat_col-40">
                                                        <button type="button" class="jury_nat_edit">
                                                            <a style="text-decoration: none;color:white;" class=""  
                                                                href='."jury_nat_conf_edit.php?value=$row[0]".' target="_blank">Edit
                                                            </a>
                                                         </button>
                                                    </div>
                                     
                                                    <div class="jury_nat_col-45">
                                                        <button type="button" class="jury_nat_del">
                                                            <a style="text-decoration: none;color:white;" class="" 
                                                                href='."jury_nat_conf_delete.php?del=$row[0]".' target="_blank">Delete
                                                            </a>
                                                        </button>
                                                    </div>
                                                </div>';
                                ...
                                <div id="wrapper">
                                    <button type="button" class="jury_nat_add_new" >
                                        <a style="text-decoration: none;color:white;"
                                            href="jury_nat_conf_insert.php">Add New Conference
                                        </a>
                                    </button>
                                </div>
                            </div>
                        ...
                        <?php
                            ...
                            if ($page >= 2) {
                               echo "<a href='jury_nat_conf_action.php?page=" . ($page - 1) . "'>  
                               <i  class='fas'>&#xf053;</i></a>";
                            }
                            echo "<a class='nice'>";
                            echo $page;
