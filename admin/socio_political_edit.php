    ...
    if (
      ...
      try {
        ...
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
         ...
         $stmt = "UPDATE socio SET title='$title', name='$name',
         organized='$org', date= '$date' WHERE socio_id='$val'";
...
<!--<li class="nav-item">
            ...
            <main role="main" class="ml-sm-12 col-12">
                <div class="tm-section-wrap">
                    ...
                    <h3 class="head2"> Edit To Socio-Political Activities </h3>
                    <br>
                    <br>
                    <?php
                       require_once "pdo.php";
                       $stmt = $pdo->prepare("SELECT * FROM socio where socio_id = :val");
                       $stmt->execute(array(":val" => $_GET['value']));
                       $row = $stmt->fetch(PDO::FETCH_ASSOC);
                         $t = htmlentities($row['title']);
                         $n = htmlentities($row['name']);
                         $o = htmlentities($row['organized']);
                    ...
                    <div class="container-insert">
                        <form action="" method="POST" class="form">
                            <div class="row">
                                ...
                                <div class="col-65">
                                    <input type="text" name="title" list="n"
                                    value="<?= $t ?>">
                                ...
                                <div class="col-65">
                                    <input type="text" name="org" list="or"
                                    value="<?= $o ?>"> 
                                ...
                                <div class="col-65">
                                    <input type="text" name="date"list="d"
                                    value="<?= $d ?>">
                                ...
                                <a href="socio_political_action.php" class="cancelbtn">Cancel</a>
                                </div>
                            </div>
                        </form>
                    </div>
