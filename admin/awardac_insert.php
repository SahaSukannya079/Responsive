...
if (empty($_SESSION['email'])) {
  ...
  if (
    isset($_POST["submit"]) && !empty($_POST["year"])
    && !empty($_POST["scholarship"]) && !empty($_POST["abody"])
  ) {
    $year = $_POST["year"];
    ...
    try {
      ...
      $stmt = "insert into academic (academic_id,admin_id,year,scholarship,abody) 
            values(' ','$admin_id','$year', '$scholarship', '$abody');";
      $conn->exec($stmt);

      echo "<script>window.alert('Academic Awards Posted to the CMS System Successful!!');</script>";
      echo "<script>window.location.assign('admin_awardac.php');</script>";
      header("Location:../awardac.php");
        ...
        <div class="row">
            ...
            <main role="main" class="ml-sm-12 col-12">
                <div class="tm-section-wrap">
                    ...
                    <h3 class="head2"> Insert To Academic Scholarships and Awards</h3>
                    <br>
                    <br>
                    ...
                    <div class="container-insert">
                        <form action="" method="POST" class="form">
                            <div class="row">
                                ...
                                <div class="col-65">
                                   <input type="text" name="year" placeholder="Enter Date">
                                </div>
                                <br>
                                <div class="col-25">
                                  <label for="scholarship"> Scholarship/Award </label>
                                </div>
                                <div class="col-65">
                                  <input type="text" name="scholarship" placeholder="Enter Scholarship/Award Name">
                                </div>
                                <br>
                                <div class="col-25">
                                   <label for="abody"> Awarding Body </label>
                                </div>
                                <div class="col-65">
                                  <input type="text" name="abody" placeholder="Enter Awarding Body">
                                </div>
                                <br>
                                <br>
                                <div class="sub_btn">
