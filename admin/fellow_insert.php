...
if (empty($_SESSION['email'])) {
  ...
  if (isset($_POST["submit"]) && !empty($_POST["year"]) && !empty($_POST["society"])) {
    $year = $_POST["year"];
    ...
    try {
      ...
      $stmt = "insert into fellow (fellow_id,admin_id,year,society) 
            values(' ','$admin_id','$year', '$society');";
      $conn->exec($stmt);

      echo "<script>window.alert('Fellowship Posted to the CMS System Successful!!');</script>";
      echo "<script>window.location.assign('admin_fellow.php');</script>";
      header("Location:../fellow.php");
        ...
        <div class="row">
            ...
            <main role="main" class="ml-sm-12 col-12">
                <div class="tm-section-wrap">
                    <h2 class="heading">Insert To Fellowships</h2>
                    <br>
                    <br>
                    ...
                    <div class="container-insert">
                        <form action="" method="POST" class="form">
                            <div class="row">
                                ...
                                <br>
                                <div class="col-25">
                                   <label for="society"> Society / College </label>
                                </div>
                                <div class="col-65">
                                    <input type="text" name="society" placeholder="Enter Society / College Name">
                                </div>
                                <br>
                                <div class="sub_btn">
