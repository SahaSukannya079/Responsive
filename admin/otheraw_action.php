        ...
        <main class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="ml-sm-12 col-12">
                    <div class="tm-section-wrap other_back_image">

                   
                         <h2 class="ot_heading">Awards</h2>
                         <h3 class="ot_head2">Other Awards</h3>

                        <section class="row tm-section">
                            <div id="ot" class="section-ot">

                                <ul class="ot_ul">
                                    <?php
                                        require_once "pdo.php";

                                        $stmt = $pdo->query("SELECT * FROM otheraw");
                                    ...
                                    $stmt = 'SELECT * FROM otheraw LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
                                    ...
                                    $rows = $pdostmt->fetchAll(PDO::FETCH_BOTH);
                                         ...
                                         foreach ($rows as $row) {
                                            ...
                                            echo  '<div class="ot">';
                                            echo  '<img src="../img/other_bk.png" alt="aw3" class="img_fluid">';
                                            echo  '<div class="ot-content">';
                                            echo  '<h3 class="ot-year">'.'<b class="ot_title">Year:</b>' .htmlentities($row['year']).'</h3>';
                                            echo  '<h3 class="ot-sch">'.'<b class="ot_title">Scholarship:</b>'.'<br>'.htmlentities($row['scholarship']).'</h3>';
                                            echo  '<h3 class="ot-abd">'.'<b class="ot_title">Awarding Body:</b>'.'<br>'.htmlentities($row['abody']).'</h3>';
                                            echo  '<br>'; 

                                            echo '<div id="wrapper">
                                                    <div class="ot_col-40">
                                                        <button type="button" class="ot_edit">
                                                            <a style="text-decoration: none;color:white;" class=""  
                                                                href='."otheraw_edit.php?value=$row[0]".' target="_blank">Edit
                                                            </a>
                                                         </button>
                                                    </div>
                                     
                                                    <div class="ot_col-45">
                                                        <button type="button" class="ot_del">
                                                            <a style="text-decoration: none;color:white;" class="" 
                                                                href='."otheraw_delete.php?del=$row[0]".' target="_blank">Delete
                                                            </a>
                                                        </button>
                                                    </div>
                                                </div>';
                                ...
                                <div id="wrapper">
                                    <button type="button" class="ot_add_new" >
                                        <a style="text-decoration: none;color:white;"
                                            href="otheraw_insert.php">Add New Award
                                        </a>
                                    </button>
                                </div>
                        ...
                        <?php
                            ...
                            if ($page >= 2) {
                               echo "<a href='otheraw_action.php?page=" . ($page - 1) . "'>  
                               <i  class='fas'>&#xf053;</i> </a>";
                            }
                            echo "<a class='nice'>";
                            echo $page;
