        ...
        <main class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="ml-sm-12 col-12">
                    <div class="tm-section-wrap invited_back_image">
                    <br>
                    <h2 class="invited_heading">Invited Speaker</h2>
                    <br>
                    <br>
                    <br>
                    <br>
                    ...
                    <div id="invited" class="section-invited wb">
                        <div class="row">  
                            <div class="col-xl-6 mb-5 ">
                                <div class="invited">
                                    <img src="../img/speaker.png" alt="invn" class="img_fluid1">
                                    <div class="invited-content">
                                    <h3 class="title-invited">International Conferences</h3>
                                        <button class="btn-invited"  href="javascript:void(0);" 
                                           onclick="window.location.href='invited_inter_conf_action.php'">
                                           Click here 
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-6 mb-5">
                                <div class="invited">
                                <img src="../img/speaker.png" alt="invn" class="img_fluid">
                                    <div class="invited-content">
                                        <h3 class="title-invited2">National Conferences</h3>
                                        <br>
                                        <button class="btn-invited2"  href="javascript:void(0);" 
                                         onclick="window.location.href='invited_nat_conf_action.php'">
                                         Click here 
                                        </button>
                                    </div>
                                </div>
