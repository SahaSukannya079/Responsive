        ...
        <main class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="ml-sm-12 col-12">
                    <div class="tm-section-wrap oral_int_back_image">
                    
                    <h2 class="oral_int_heading">Oral Presentation</h2>
                    <h3 class="oral_int_head2">International Conference</h3>
                         
                        <section class="row tm-section">
                            <div id="oral_int" class="section-oral_int">

                                <ul class="oral_int_ul">
                                    <?php
                                        require_once "pdo.php";

                                        $stmt = $pdo->query("SELECT * FROM oral_inter_conf");
                                        ...
                                        $stmt = 'SELECT * FROM oral_inter_conf LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
                                        ...
                                        $rows = $pdostmt->fetchAll(PDO::FETCH_BOTH);
                                         ...
                                         foreach ($rows as $row) {
                                            ...
                                            echo  '<div class="oral_int">';
                                            echo  '<img src="../img/ms1.png" alt="orali" class="img_fluid">';
                                            echo  '<div class="oral_int-content">';
                                            echo   "<i class='far'>&#xf0a4;</i> <span class='oral_int-title'>" . htmlentities($row['title']) . ".\t" . "</span>";
                                            echo   "<b class='oral_int-conf'>" . htmlentities($row['conf_name']) . ",</b>" . "\t";
                                            echo   "<span class='oral_int-date'>" . htmlentities($row['date']) . ".</span>";
                                          
                                            echo  '<br>'; 

                                            echo '<div id="wrapper">
                                                    <div class="oral_int_col-40">
                                                        <button type="button" class="oral_int_edit">
                                                            <a style="text-decoration: none;color:white;" class=""  
                                                                href='."oral_inter_conf_edit.php?value=$row[0]".' target="_blank">Edit
                                                            </a>
                                                         </button>
                                                    </div>
                                     
                                                    <div class="oral_int_col-45">
                                                        <button type="button" class="oral_int_del">
                                                            <a style="text-decoration: none;color:white;" class="" 
                                                                href='."oral_inter_conf_delete.php?del=$row[0]".' target="_blank">Delete
                                                            </a>
                                                        </button>
                                                    </div>
                                                </div>';
                                ...
                                <div id="wrapper">
                                    <button type="button" class="oral_int_add_new" >
                                        <a style="text-decoration: none;color:white;"
                                            href="oral_inter_conf_insert.php">Add New Conference
                                        </a>
                                    </button>
                                </div>
                            </div>
                        ...
                        if ($page >= 2) {
                           echo "<a href='oral_inter_conf_action.php?page=" . ($page - 1) . "'> 
