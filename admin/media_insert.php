...
if (empty($_SESSION['email'])) {
  ...
  if (isset($_POST["submit"]) && !empty($_POST["para"])) {
    ...
    try {
      ...
      $stmt = "insert into media (media_id,admin_id,paragraph) 
            values(' ','$admin_id','$paragraph');";
      $conn->exec($stmt);

      echo "<script>window.alert('media Section Paragraph Posted to the CMS System Successful!!');</script>";
      echo "<script>window.location.assign('media_action.php');</script>";
      header("Location:media_action.php");
        ...
        <div class="row">
            ...
            <main role="main" class="ml-sm-12 col-12">
                <div class="tm-section-wrap">
                    <h2 class="heading">Insert To Presence In Media</h2>
                    <br>
                    <br>
                    ...
                    <div class="container-insert">
                        <form action="" method="POST" class="form">
                            <div class="row">
                                <div class="col-25">
                                <label for="paragraph">Presence In Media</label>
                                </div>
                                <div class="col-65">
                                <textarea id="paragraph" name="para" placeholder="Enter Presence In Media" style="height:200px"></textarea>
                                </div>
                                <br>
                                <br>
                                <div class="sub_btn">
