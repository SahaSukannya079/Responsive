  ...
  if (isset($_POST["submit"])) {
    ...
    try {
      ...
      $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
       ...
       $stmt = "UPDATE media SET paragraph='$paragraph' WHERE media_id='$val'";
        ...
        <div class="row">
            ...
            <main role="main" class="ml-sm-12 col-12">
                <div class="tm-section-wrap">
                    <h2 class="heading">Edit Presence In Media</h2>
                    <br>
                    <br>
                    <?php
                       require_once "pdo.php";
                       $stmt = $pdo->prepare("SELECT * FROM media where media_id = :val");
                    ...
                    <div class="container-insert">
                        <form action="" method="POST" class="form">
                            <div class="row">
                                ...
                                <div class="col-65">
                                <textarea id="paragraph" name="para"
                                style="height:200px">
                                <?php echo $p; ?>
                                </textarea>
                                </div>
                                ...
                                <a href="media_action.php" class="cancelbtn"
