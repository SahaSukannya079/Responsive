        ...
        <main class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="ml-sm-12 col-12">
                    <div class="tm-section-wrap org_nat_back_image">
                   
                    <h2 class="org_nat_heading">Organizing Experience </h2>
                    <h3 class="org_nat_head2">National </h3>
                         
                        <section class="row tm-section">
                            <div id="org_nat" class="section-org_nat">

                                <ul class="org_nat_ul">
                                    <?php
                                        require_once "pdo.php";

                                        $stmt = $pdo->query("SELECT * FROM organizing_nation");
                                        ...
                                        $stmt = 'SELECT * FROM organizing_nation LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
                                        ...
                                        $rows = $pdostmt->fetchAll(PDO::FETCH_BOTH);
                                         ...
                                         foreach ($rows as $row) {
                                            ...
                                            echo  '<div class="org_nat">';
                                            echo  '<img src="../img/org_nat_back.png" alt="org2" class="img_fluid">';
                                            echo  '<div class="org_nat-content">';
                                            echo  "<h3 class='org_nat-org'>"."<b class='org_boldn'>Organization: </b>" ."\t".htmlentities($row['organization']) . ".<br>";
                                            echo  "<h3 class='org_nat-pos'>"."<b class='org_boldn'>Position:</b>" ."\t".htmlentities($row['position']) . ".<br>";
                                            
                                          
                                            echo  '<br>'; 

                                            echo '<div id="wrapper">
                                                    <div class="org_nat_col-40">
                                                        <button type="button" class="org_nat_edit">
                                                            <a style="text-decoration: none;color:white;" class=""  
                                                                href='."organize_nat_edit.php?value=$row[0]".' target="_blank">Edit
                                                            </a>
                                                         </button>
                                                    </div>
                                     
                                                    <div class="org_nat_col-45">
                                                        <button type="button" class="org_nat_del">
                                                            <a style="text-decoration: none;color:white;" class="" 
                                                                href='."organize_nat_delete.php?del=$row[0]".' target="_blank">Delete
                                                            </a>
                                                        </button>
                                                    </div>
                                                </div>';
                                ...
                                <div id="wrapper">
                                    <button type="button" class="org_nat_add_new" >
                                        <a style="text-decoration: none;color:white;"
                                            href="organize_nat_insert.php">Add New Experience 
                                        </a>
                                    </button>
                                </div>
                            </div>
                        ...
                        if ($page >= 2) {
                           echo "<a href='organize_nat_action.php?page=" . ($page - 1) . "'>  
                           <i  class='fas'>&#xf053;</i> </a>";
                        }
                        echo "<a class='nice'>";
                        echo $page;
