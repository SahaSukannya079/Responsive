...
if (empty($_SESSION['email'])) {
  ...
  if (
    ...
    try {
      ...
      $stmt = "insert into otheraw (otheraw_id,admin_id,year,scholarship,abody) 
            values(' ','$admin_id','$year', '$scholarship', '$abody');";
      $conn->exec($stmt);

      echo "<script>window.alert('Other Awards Posted to the CMS System Successful!!');</script>";
      echo "<script>window.location.assign('otheraw_action.php');</script>";
      header("Location:otheraw_action.php");
      header("Location:../otheraw.php");
        ...
        <div class="row">
            ...
            <main role="main" class="ml-sm-12 col-12">
                <div class="tm-section-wrap">
                    ...
                    <h3 class="head2"> Insert To Other Awards</h3>
                    <br>
                    <br>
