...
<!--<li class="nav-item">
                ...
                <main role="main" class="ml-sm-12 col-12">
                    <div class="tm-section-wrap session_nat_back_image">
                   
                    <h2 class="session_nat_heading">Session Chair</h2>
                    <h3 class="session_nat_head2">National Conference</h3>
                         
                        <section class="row tm-section">
                            <div id="session_nat" class="section-session_nat">

                                <ul class="session_nat_ul">
                                    <?php
                                        require_once "pdo.php";

                                        $stmt = $pdo->query("SELECT * FROM session_nat_conf");
                                        ...
                                        $stmt = 'SELECT * FROM session_nat_conf LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
                                        ...
                                        $rows = $pdostmt->fetchAll(PDO::FETCH_BOTH);
                                         ...
                                         foreach ($rows as $row) {
                                            ...
                                            echo  '<div class="session_nat">';
                                            echo  '<img src="../img/ses_nat_back.png" alt="se1" class="img_fluid">';
                                            echo  '<div class="session_nat-content">';
                                            echo  "<h3 class='session_nat-title'>".htmlentities($row['title']) .".". "<br>";
                                            echo  "<h3 class='session_nat-conf'>"."<b class='bold_name'>".htmlentities($row['conf_name']) .",". "<br>";
                                            echo  "<h3 class='session_nat-date'>".htmlentities($row['date']).".";
                                          
                                            echo  '<br>'; 

                                            echo '<div id="wrapper">
                                                    <div class="session_nat_col-40">
                                                        <button type="button" class="session_nat_edit">
                                                            <a style="text-decoration: none;color:white;" class=""  
                                                                href='."session_nat_conf_edit.php?value=$row[0]".' target="_blank">Edit
                                                            </a>
                                                         </button>
                                                    </div>
                                     
                                                    <div class="session_nat_col-45">
                                                        <button type="button" class="session_nat_del">
                                                            <a style="text-decoration: none;color:white;" class="" 
                                                                href='."session_nat_conf_delete.php?del=$row[0]".' target="_blank">Delete
                                                            </a>
                                                        </button>
                                                    </div>
                                                </div>';
                                ...
                                <div id="wrapper">
                                    <button type="button" class="session_nat_add_new" >
                                        <a style="text-decoration: none;color:white;"
                                            href="session_nat_conf_insert.php">Add New Conference
                                        </a>
                                    </button>
                                </div>
                            </div>
                        ...
                        echo '<div class="pagination childa" >';
                        if ($page >= 2) {
                           echo "<a href='session_nat_conf_action.php?page=" . ($page - 1) . "'> 
                           <i  class='fas' id='sci_nat'>&#xf053;</i>  </a>";
                        }

                        echo "<a class='sci_nat_nice'>";
                        echo $page;

                        echo "<a class='sci_nat_nicee' >";
                        echo " / ";
