        ...
        <main class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="ml-sm-12 col-12">
                    <div class="tm-section-wrap jury_int_back_image">
                    
                    <h2 class="jury_int_heading">Jury / Moderator / </h2>
                    <h2 class="jury_int_heading2">Panelist / Resource Person </h2>
                    <h3 class="jury_int_head2">International Conference</h3>
                         
                        <section class="row tm-section">
                            <div id="jury_int" class="section-jury_int">

                                <ul class="jury_int_ul">
                                    <?php
                                        require_once "pdo.php";

                                        $stmt = $pdo->query("SELECT * FROM jury_inter_conf");
                                        ...
                                        $stmt = 'SELECT * FROM jury_inter_conf LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
                                        ...
                                        $rows = $pdostmt->fetchAll(PDO::FETCH_BOTH);
                                         ...
                                         foreach ($rows as $row) {
                                            ...
                                            echo  '<div class="jury_int">';
                                            echo  '<img src="../img/jury_int_back.png" alt="juryint" class="img_fluid">';
                                            echo  '<div class="jury_int-content">';
                                            echo  "<i style='font-size:24px' class='far'>&#xf0a4;</i> <span class='jury_int-title'>" . htmlentities($row['title']) . ".\t" . "</span>";
                                            echo   "<span class='jury_int-conf'>" . htmlentities($row['conf_name']). ",\t". "</span>";
                                            echo   "<span class='jury_int-date'>" . htmlentities($row['date']) . ".</span>";
                                          
                                            echo  '<br>'; 

                                            echo '<div id="wrapper">
                                                    <div class="jury_int_col-40">
                                                        <button type="button" class="jury_int_edit">
                                                            <a style="text-decoration: none;color:white;" class=""  
                                                                href='."jury_inter_conf_edit.php?value=$row[0]".' target="_blank">Edit
                                                            </a>
                                                         </button>
                                                    </div>
                                     
                                                    <div class="jury_int_col-45">
                                                        <button type="button" class="jury_int_del">
                                                            <a style="text-decoration: none;color:white;" class="" 
                                                                href='."jury_inter_conf_delete.php?del=$row[0]".' target="_blank">Delete
                                                            </a>
                                                        </button>
                                                    </div>
                                                </div>';
                                ...
                                <div id="wrapper">
                                    <button type="button" class="jury_int_add_new" >
                                        <a style="text-decoration: none;color:white;"
                                            href="jury_inter_conf_insert.php">Add New Conference
                                        </a>
                                    </button>
                                </div>
                            </div>
                        ...
                        if ($page >= 2) {
                           echo "<a href='jury_inter_conf_action.php?page=" . ($page - 1) . "'>  
                           <i  class='fas'>&#xf053;</i></a>";
                        }
                        echo "<a class='nice'>";
                        echo $page;
