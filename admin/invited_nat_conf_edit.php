    ...
    if (
      ...
      try {
        ...
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
         ...
         $stmt = "UPDATE nat_conf SET title='$title', conf_name='$conf',
          date= '$date' WHERE nat_conf_id='$val'";
           
         
         $conn->exec($stmt);
         
         echo "<script>window.alert('Status Changed to Available');</script>";
         echo "<script>window.location.assign('invited_nat_conf_action.php');</script>";
        ...
        <div class="row">
            ...
            <main role="main" class="ml-sm-12 col-12">
                <div class="tm-section-wrap">
                    ...
                    <?php
                       require_once "pdo.php";
                       $stmt = $pdo->prepare("SELECT * FROM nat_conf where nat_conf_id = :val");
