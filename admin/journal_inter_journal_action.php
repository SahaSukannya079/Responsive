        ...
        <main class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="ml-sm-12 col-12">
                    <div class="tm-section-wrap jour_int_back_image">
                    
                    <h2 class="jour_int_heading">Member of Journal Editorial Boards</h2>
                    <h3 class="jour_int_head2">International Journal</h3>
                         
                        <section class="row tm-section">
                            <div id="jour_int" class="section-jour_int">

                                <ul class="jour_int_ul">
                                    <?php
                                        require_once "pdo.php";

                                        $stmt = $pdo->query("SELECT * FROM journal_int_journal");
                        $rows = $stmt->fetchAll(PDO::FETCH_BOTH);

                        $results_per_page = 2; // Results per page
                        ...
                        $stmt = 'SELECT * FROM journal_int_journal LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
                        ...
                        $rows = $pdostmt->fetchAll(PDO::FETCH_BOTH);
                                         ...
                                         foreach ($rows as $row) {
                                            ...
                                            echo  '<div class="jour_int">';
                                            echo  '<img src="../img/org_back.png" alt="journal_int" class="img_fluid">';
                                            echo  '<div class="jour_int-content">';
                                            echo  "<h3 class='jour_int-title'>".htmlentities($row['title']) . "<br>";
                                            echo  "<h3 class='jour_int-pub'>".htmlentities($row['official_publication']) . "<br>";
                                            echo  "<h3 class='jour_int-pos'>".htmlentities($row['position']);
                                          
                                            echo  '<br>'; 

                                            echo '<div id="wrapper">
                                                    <div class="jour_int_col-40">
                                                        <button type="button" class="jour_int_edit">
                                                            <a style="text-decoration: none;color:white;" class=""  
                                                                href='."journal_inter_journal_edit.php?value=$row[0]".' target="_blank">Edit
                                                            </a>
                                                         </button>
                                                    </div>
                                     
                                                    <div class="jour_int_col-45">
                                                        <button type="button" class="jour_int_del">
                                                            <a style="text-decoration: none;color:white;" class="" 
                                                                href='."journal_inter_journal_delete.php?del=$row[0]".' target="_blank">Delete
                                                            </a>
                                                        </button>
                                                    </div>
                                                </div>';
                                ...
                                <div id="wrapper">
                                    <button type="button" class="jour_int_add_new" >
                                        <a style="text-decoration: none;color:white;"
                                            href="journal_inter_journal_insert.php">Add New Journal
                                        </a>
                                    </button>
                                </div>
                                <br><br><br>
                        ...
                        <?php
                            ...
                            if ($page >= 2) {
                               echo "<a href='journal_inter_journal_action.php?page=" . ($page - 1) . "'>  
                               <i  class='fas'>&#xf053;</i> </a>";
                            }
                            echo "<a class='nice'>";
                            echo $page;
