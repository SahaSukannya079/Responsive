...
if (empty($_SESSION['email'])) {
  ...
  if (
    ...
    try {
      ...
      $stmt = "insert into researchaw (researchaw_id,admin_id,year,scholarship,abody) 
            values(' ','$admin_id','$year', '$scholarship', '$abody');";
      $conn->exec($stmt);

      echo "<script>window.alert('Research Awards Posted to the CMS System Successful!!');</script>";
      echo "<script>window.location.assign('researchaw_action.php');</script>";
      header("Location:researchaw_action.php");
      header("Location:../researchaw.php");
        ...
        <div class="row">
            ...
            <main role="main" class="ml-sm-12 col-12">
                <div class="tm-section-wrap">
                    ...
                    <h3 class="head2"> Insert To Research Awards</h3>
                    <br>
                    <br>
                        ...
                        <form action="" method="POST" class="form">
                            <div class="row">
                               <div class="col-25">
                                ...
                                <div class="col-65">
                                   <input type="text" name="scholarship" placeholder="Enter Award Name">
                                </div>
                                <br>
                                <div class="col-25">
