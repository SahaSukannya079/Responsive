...
if (empty($_SESSION['email'])) {
  echo "<script>window.location.assign('login.php');</script>";
    ...
    if (isset($_POST["submit"]) && !empty($_POST["pub"])
     && !empty($_POST["author"]) && !empty($_POST["publi"]) 
     && !empty($_POST["year"])
     ){
      ...
      try {
        ...
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
         ...
         $stmt = "UPDATE literary SET publication_name='$pub', author_name= '$author', 
         publisher= '$publi', year= '$year' WHERE literary_id='$val'";
        ...
        <div class="row">
            ...
            <main role="main" class="ml-sm-12 col-12">
                <div class="tm-section-wrap">
                    ...
                    <?php
                       require_once "pdo.php";
                       $stmt = $pdo->prepare("SELECT * FROM literary where literary_id = :val");
                       $stmt->execute(array(":val" => $_GET['value']));
                       $row = $stmt->fetch(PDO::FETCH_ASSOC);
                         $pu = htmlentities($row['publication_name']);
                    ...
                    <div class="container-insert">
                        <form action="" method="POST" class="form">
                            <div class="row">
                                ...
                                <div class="col-65">
                                   <input type="text" name="pub" value="<?= $pu ?>">
                                </div>
                                <br>
                                <div class="col-25">
                                ...
                                <div class="col-65">
                                  <input type="text" name="publi" value="<?= $p ?>">
                                </div>
                                <br>
                                <div class="col-25">
                                ...
                                <a href="literary_action.php" class="cancelbtn"
