        ...
        <main class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="ml-sm-12 col-12">
                    <div class="tm-section-wrap award_back_image">
                    <h2 class="award_menu_heading">Awards</h2>

                    <section class="row tm-section">
                        <div id="award" class="section-award">
                        <!--<div class="row">  -->
                            <div class="col-xl-6 mb-5">
                                <div class="award">
                                    <img src="../img/award_sestion_back_main.png" alt="aw" class="img_fluid">
                                    <div class="award-content">
                                    <h3 class="title-award-ac">Academic Scholarships and Awards</h3>
                                        <button class="btn-ac"  href="javascript:void(0);" 
                                           onclick="window.location.href='awardac_action.php'">
                                           Click here 
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-6 mb-5">
                                ...
                                <img src="../img/award_sestion_back_main.png" alt="aw" class="img_fluid">
                                    <div class="award-content">
                                        <h3 class="title-award-ra">Research Awards</h3>
                                        <br>
                                        <button class="btn-ra"  href="javascript:void(0);" 
                                         onclick="window.location.href='researchaw_action.php'">
                                         Click here 
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-6 mb-5">
                                ...
                                <img src="../img/award_sestion_back_main.png" alt="aw" class="img_fluid">
                                    <div class="award-content">
                                        <h3 class="title-award-oa">Other Awards</h3>
                                        <br>
                                        <button class="btn-oa"  href="javascript:void(0);" 
                                         onclick="window.location.href='otheraw_action.php'">
                                         Click here 
                                        </button>
                                    </div>
                                </div>
