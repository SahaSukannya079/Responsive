    ...
    if (
      ...
      try {
        ...
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
         ...
         $stmt = "UPDATE organizing_inter SET organization='$org', position='$pos'
         WHERE organizing_inter_id='$val'";
        ...
        <div class="row">
            ...
            <main role="main" class="ml-sm-12 col-12">
                <div class="tm-section-wrap">
                    ...
                    <?php
                       require_once "pdo.php";
                       $stmt = $pdo->prepare("SELECT * FROM organizing_inter where organizing_inter_id = :val");
                       $stmt->execute(array(":val" => $_GET['value']));
                       $row = $stmt->fetch(PDO::FETCH_ASSOC);
                         $o = htmlentities($row['organization']);
                         $p = htmlentities($row['position']);
                         $val = $row['organizing_inter_id']; 
                    ...
                    <div class="container-insert">
                        <form action="" method="POST" class="form">
                            ...
                            <div class="col-25">
                                ...
                                <a href="organize_int_action.php" class="cancelbtn">Cancel</a>
                                </div>
                            </div>
                        </form>
                    </div>
