        ...
        <main class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="ml-sm-12 col-12">
                    <div class="tm-section-wrap org_int_back_image">

                    
                    <h2 class="org_int_heading">Organizing Experience </h2>
                    <h3 class="org_int_head2">International </h3>
                         
                        <section class="row tm-section">
                            <div id="org_int" class="section-org_int">

                                <ul class="org_int_ul">
                                    <?php
                                        require_once "pdo.php";

                                        $stmt = $pdo->query("SELECT * FROM organizing_inter");
                                        ...
                                        $stmt = 'SELECT * FROM organizing_inter LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
                                        ...
                                        $rows = $pdostmt->fetchAll(PDO::FETCH_BOTH);
                                         ...
                                         foreach ($rows as $row) {
                                            ...
                                            echo  '<div class="org_int">';
                                            echo  '<img src="../img/org_int_back.png" alt="org1" class="img_fluid">';
                                            echo  '<div class="org_int-content">';
                                            echo  "<h3 class='org_int-org'>"."<b class='org_bold'>Organization: </b>" ."\t".htmlentities($row['organization']) . ".<br>";
                                            echo  "<h3 class='org_int-pos'>"."<b class='org_bold'>Position:</b>" ."\t".htmlentities($row['position']) . ".<br>";
                                            
                                          
                                            echo  '<br>'; 

                                            echo '<div id="wrapper">
                                                    <div class="org_int_col-40">
                                                        <button type="button" class="org_int_edit">
                                                            <a style="text-decoration: none;color:white;" class=""  
                                                                href='."organize_int_edit.php?value=$row[0]".' target="_blank">Edit
                                                            </a>
                                                         </button>
                                                    </div>
                                     
                                                    <div class="org_int_col-45">
                                                        <button type="button" class="org_int_del">
                                                            <a style="text-decoration: none;color:white;" class="" 
                                                                href='."organize_int_delete.php?del=$row[0]".' target="_blank">Delete
                                                            </a>
                                                        </button>
                                                    </div>
                                                </div>';
                                ...
                                <div id="wrapper">
                                    <button type="button" class="org_int_add_new" >
                                        <a style="text-decoration: none;color:white;"
                                            href="organize_int_insert.php">Add New Experience 
                                        </a>
                                    </button>
                                </div>
                            </div>
                        ...
                        if ($page >= 2) {
                           echo "<a href='organize_int_action.php?page=" . ($page - 1) . "'>  
                           <i  class='fas'>&#xf053;</i> </a>";
                        }
                        echo "<a class='nice'>";
                        echo $page;
