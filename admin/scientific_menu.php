        ...
        <main class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="ml-sm-12 col-12">
                    <div class="tm-section-wrap scientific_back_image">
                    <h2 class="scientific_heading">Scientific Publications</h2>
                    <br>
                    <br>

                    
                    <section class="row tm-section">
                      <div id="scientific" class="section-scientific">
                        <div class="row">  
                            <div class="col-xl-6 mb-5">
                                <div class="scientific">
                                    <img src="../img/scientific_back.png" alt="sci1" class="img_fluid">
                                    <div class="scientific-content">
                                    <h3 class="title-scientific">International Journal</h3>
                                        <button class="btn"  href="javascript:void(0);" 
                                           onclick="window.location.href='scientific_inter_jour_action.php'">
                                           Click here 
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-6 mb-5 column">
                                <div class="scientific">
                                    <img src="../img/scientific_back.png" alt="sci1" class="img_fluid">
                                    <div class="scientific-content">
                                    <h3 class="title-scientific">National Journal</h3>
                                        <button class="btn"  href="javascript:void(0);" 
                                           onclick="window.location.href='scientific_nat_jour_action.php'">
                                           Click here 
                                        </button>
                                    </div>
                                </div>
