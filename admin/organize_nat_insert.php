...
if (empty($_SESSION['email'])) {
    ...
    if (
        ...
        try {
            ...
            $stmt = "insert into organizing_nation (organizing_nation_id,admin_id,organization,position) 
            values(' ','$admin_id','$org', '$pos');";
            $conn->exec($stmt);

            echo "<script>window.alert('International Posted to the CMS System Successful!!');</script>";
            echo "<script>window.location.assign('organize_nat_action.php');</script>";
            header("Location:../organize_nat.php");
            header("Location:organize_nat_action.php");
        ...
        <div class="row">
            ...
            <main role="main" class="ml-sm-12 col-12">
                <div class="tm-section-wrap">
                    ...
                    <h3 class="head2">Insert To National</h3>
                    <br>
                    <br>
