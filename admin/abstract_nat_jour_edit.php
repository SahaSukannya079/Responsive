    ...
    if (
      ...
      try {
        ...
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
         ...
         $stmt = "UPDATE abstract_nat_journal SET title='$title', author_name='$author_name',
          publication ='$pub', page ='$page' WHERE abstract_nat_journal_id='$val'";
           
         
         $conn->exec($stmt);
         
         echo "<script>window.alert('Status Changed to Available');</script>";
         echo "<script>window.location.assign('abstract_nat_jour_action.php');</script>";
        ...
        <div class="row">
            ...
            <main role="main" class="ml-sm-12 col-12">
                <div class="tm-section-wrap">
                    ...
                    <?php
                       require_once "pdo.php";
                       $stmt = $pdo->prepare("SELECT * FROM abstract_nat_journal where abstract_nat_journal_id = :val");
                       ...
                       $row = $stmt->fetch(PDO::FETCH_ASSOC);
                         ...
                         $val = $row['abstract_nat_journal_id']; 
                    ...
                    <div class="container-insert">
                        <form action="" method="POST" class="form">
                            <div class="row">
                                ...
                                <a href="abstract_nat_jour_action.php" class="cancelbtn">Cancel</a>
                                </div>
                            </div>
                        </form>
                    </div>
