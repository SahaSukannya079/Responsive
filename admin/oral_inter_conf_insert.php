...
if (empty($_SESSION['email'])) {
    ...
    if (
        ...
        try {
            ...
            $stmt = "insert into oral_inter_conf (oral_inter_conf_id,admin_id,title,conf_name,date) 
            ...
            header("Location:../oral_inter_conf.php");
            header("Location:oral_inter_conf_action.php");
