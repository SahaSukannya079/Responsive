...
if (empty($_SESSION['email'])) {
  ...
  if (isset($_POST["submit"]) && !empty($_POST["para"])) {
    ...
    try {
      ...
      $stmt = "insert into about (about_id,admin_id,paragraph) 
            values(' ','$admin_id','$paragraph');";
      $conn->exec($stmt);

      echo "<script>window.alert('About Section Paragraph Posted to the CMS System Successful!!');</script>";
      echo "<script>window.location.assign('about_action.php');</script>";
      header("Location:about_action.php");
        ...
        <div class="row">
            ...
            <main role="main" class="ml-sm-12 col-12">
                <div class="tm-section-wrap">
                    <h2 class="heading">Insert To About Section</h2>
                    <br>
                    <br>
                    ...
                    <div class="container-insert">
                        <form action="" method="POST" class="form">
                            <div class="row">
                                ...
                                <div class="col-65">
                                <textarea id="paragraph" name="para" placeholder="Write something.." style="height:200px"></textarea>
                                </div>
                                <br>
                                <br>
                                <div class="sub_btn">
                                   <input type="submit" name="submit" value="Insertt">
                                </div>
                            </div>
                        </form>
                    </div>
