        ...
        <main class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="ml-sm-12 col-12">
                    <div class="tm-section-wrap me_back_image">
                         <!-- nav starts here -->
                         <a class="navbar-brand js-scroll-trigger" href="try.php">
                        <img src="../img/rsz_logo_normal.jpg" alt="site logo" class="img-logo">
                        </a>

                        <button type="button" class="gallery_btn">
                            <i  class='far'>&#xf302;</i>
                            <a style="text-decoration: none;color:white;" class=""
                            href="" target="_blank">Gallery</a>
                        </button> 

                        <!-- nav ends here -->
                        <h2 class="me_heading">News & Events</h2>
                        ...
                        $stmt = 'SELECT * FROM media LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
                        ...
                        foreach ($rows as $row) {
                          ...
                          echo       '<div class="w-100 tm-double-border-m1 tm-box-pad-content-m ">';
                          
                          echo             '<div class="m_text_back">';
                          echo                 "<i  class='far'>&#xf0a4;</i>  <span class='m_title'>" . htmlentities($row['paragraph']) . ".\t" . "</span>";
                          ...
                          echo '<div id="wrapper">
                                 <div class="me_col-40">
                                    <button type="button" class="me_edit">
                                      <a style="text-decoration: none;color:white;" class=""  
                                        href='."media_edit.php?value=$row[0]".' target="_blank">Edit
                                      </a>
                                    </button>
                                    </div>
                         
                                  <div class="me_col-45">
                                    <button type="button" class="me_del">
                                      <a style="text-decoration: none;color:white;" class="" 
                                        href='."media_delete.php?del=$row[0]".' target="_blank">Delete
                                      </a>
                                    </button>
                                    </div>
                                  </div>';
                        ...
                        <div id="wrapper">
                            <button type="button" class="me_add_new" >
                              <a style="text-decoration: none;color:white;" 
                                href="media_insert.php">Add New Activities
                              </a>
                            </button>
                        </div>
                        <br>
                        ...
                        <?php
                            ...
                            if ($page >= 2) {
                               echo "<a href='media_action.php?page=" . ($page - 1) . "'>
                               <i  class='fas'>&#xf053;</i> </a>";
                            }
