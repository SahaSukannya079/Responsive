...
if (empty($_SESSION['email'])) {
    ...
    if (
        ...
        try {
            ...
            $stmt = "insert into jury_nat_conf (jury_nat_conf_id,admin_id,title,conf_name,date) 
            ...
            echo "<script>window.location.assign('jury_natr_conf_action.php');</script>";
           
            header("Location:jury_nat_conf_action.php");
