...
if (empty($_SESSION['email'])) {
  ...
  if (
    ...
    try {
      ...
      $stmt = "insert into working_party (working_party_id,admin_id,year,membership,party_name) 
            values(' ','$admin_id','$year', '$mship', '$pname');";
      $conn->exec($stmt);

      echo "<script>window.alert('Working Party Posted to the CMS System Successful!!');</script>";
      echo "<script>window.location.assign('working_party_action.php');</script>";
     
      header("Location:working_party_action.php");
        ...
        <div class="row">
            ...
            <main role="main" class="ml-sm-12 col-12">
                <div class="tm-section-wrap">
                    <h2 class="heading">Insert To Memberships of Working Party</h2>
                    ...
                    <div class="container-insert">
                        <form action="" method="POST" class="form">
                            <div class="row">
                                ...
                                <div class="col-65">
                                    <input type="text" name="mship" placeholder="Enter Membership ">
                                </div>
                                <br>
                                <div class="col-25">
                                ...
                                <div class="col-65">
                                  <input type="text" name="pname" list="pn" placeholder="Enter Party Name">
