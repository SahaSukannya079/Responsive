...
if (empty($_SESSION['email'])) {
  ...
  if (
    isset($_POST["submit"]) && !empty($_POST["inv_type"]) 
    && !empty($_POST["des"])  && !empty($_POST["inv_name"]) 
  ) {
    ...
    try {
      ...
      $stmt = "insert into intervention 
      (intervention_id,admin_id,intervention_type,description,intervention_name) 
            values(' ','$admin_id','$inv_type', ' $des', '$inv_name');";

      $conn->exec($stmt);

      echo "<script>window.alert('Intervention Posted to the CMS System Successful!!');</script>";
      echo "<script>window.location.assign('intervention_action.php');</script>";
      header("Location:../intervention.php");
      header("Location:intervention_action.php");
        ...
        <div class="row">
            <nav id="tmSidebar" class="tm-bg-black-transparent tm-sidebar">
                ...
                <div class="tm-brand-box">
                    ...
                    <ul id="tmMainNav" class="nav flex-column text-uppercase text-right tm-main-nav">
                            ...
                            <li class="nav-item">
                                <a href="javascript:void(0);" 
                                onclick="window.location.href='intervention_action.php'" 
            ...
            <main role="main" class="ml-sm-12 col-12">
                <div class="tm-section-wrap">
                    <h2 class="heading">Insert To Intervention</h2>
                    <br>
                    <br>
                    ...
                    <div class="container-insert">
                        <form action="" method="POST" class="form">
                             <div class="row">
                                <div class="col-25">
                                  <label for="inv_type"> Intervention Type</label>
                                </div>
                                <div class="col-65">
                                  <input type="text" name="inv_type" list="inv" placeholder="Enter Intervention Type" >
                                     <datalist id="inv" required>
                                        <option value="Endoscopy">
                                        <option value="Colonoscopy">
                                        <option value="ERCP">
                                        <option value="Liver Biopsy">
                                        <option value="Sonology">
                                ...
                                <br>
                                <div class="col-25">
                                  <label for="inv_name"> Intervention Name </label>
                                </div>
                                <div class="col-65">
                                    <input type="text" name="inv_name"  list="inv_name" placeholder="Select N/A if you want to leave this field empty">
                                      <datalist id="inv_name" required>
