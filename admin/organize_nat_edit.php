    ...
    if (
      ...
      try {
        ...
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
         ...
         $stmt = "UPDATE organizing_nation SET organization='$org', position='$pos'
         WHERE organizing_nation_id='$val'";
        ...
        <div class="row">
            ...
            <main role="main" class="ml-sm-12 col-12">
                <div class="tm-section-wrap">
                    ...
                    <h3 class="head2"> Edit To International </h3>
                    <br>
                    <br>
                    <?php
                       require_once "pdo.php";
                       $stmt = $pdo->prepare("SELECT * FROM organizing_nation where organizing_nation_id = :val");
                       $stmt->execute(array(":val" => $_GET['value']));
                       $row = $stmt->fetch(PDO::FETCH_ASSOC);
                         $o = htmlentities($row['organization']);
                         $p = htmlentities($row['position']);
                         $val = $row['organizing_nation_id']; 
                    ...
                    <div class="container-insert">
                        <form action="" method="POST" class="form">
                            ...
                            <div class="col-25">
                                ...
                                <a href="organize_nat_action.php" class="cancelbtn">Cancel</a>
                                </div>
                            </div>
                        </form>
                    </div>
