        ...
        <main class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="ml-sm-12 col-12">
                    <div class="tm-section-wrap book_back_image">
                    
                    <h2 class="heading">Books Edited</h2>
                        <?php
                        require_once "pdo.php";

                        $stmt = $pdo->query("SELECT * FROM books_edited");
                        ...
                        foreach ($rows as $row) {
                          ...
                          echo       '<li class="book_li">';
                          echo          '<div class="bkn">';
                          echo             '<div class="bkn1">';
                          echo                 htmlentities($row['book_name']);
                          echo              '</div>';
                          echo            '</div>';
                          echo            '<div class="isb">';
                          echo                "ISBN: ".htmlentities($row['ISBN']). "<br>"; 
                          echo            '</div>';
                          echo            '<div class="aut">';
                          echo                 "Authors Name: ".htmlentities($row['author_name']) ."<br>"; 
                          echo            '</div>';
                          echo            '<div class="pbl">';
                          echo                 "Publisher: ".htmlentities($row['publisher']) . "<br>";
                          echo            '</div>';
                          ...
                          echo '<div id="wrapper">
                                 <div class="col-40">
                                    <button type="button" class="bk_edit">
                                      <a style="text-decoration: none;color:white;" class=""  
                                        href='."book_edited_edit.php?value=$row[0]".' target="_blank">Edit
                                      </a>
                                    </button>
                                    </div>
                         
                                  <div class="col-45">
                                    <button type="button" class="bk_del">
                                      <a style="text-decoration: none;color:white;" class="" 
                                        href='."book_edited_delete.php?del=$row[0]".' target="_blank">Delete
                                      </a>
                                    </button>
                                    </div>
                                  </div>';
                        ...
                        <div id="wrapper">
                            <button type="button" class="bk_addnewbtn" >
                              <a style="text-decoration: none;color:white;"
                                href="book_edited_insert.php">Add New Book
                              </a>
                            </button>
                        </div>
                        <br>
