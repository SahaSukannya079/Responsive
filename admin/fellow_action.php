        ...
        <main class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="ml-sm-12 col-12">
                    <div class="tm-section-wrap fellow_back_image">
                        <!-- nav starts here -->
                        ...
                        <h2 class="fw_heading">Fellowships</h2>
                            ...
                            <div id="fw" class="section-fw">
                                ...
                                <ul class="fw_ul">
                                    <?php
                                        ...
                                        $stmt = $pdo->query("SELECT * FROM fellow");
                                        $rows = $stmt->fetchAll(PDO::FETCH_BOTH);
                                         ...
                                         foreach ($rows as $row) {
                                            ...
                                            echo  '<div class="fw">';
                                            echo  '<img src="../img/fw_back.png" alt="follow" class="img_fluid">';
                                            echo  '<div class="fw-content">';
                                            echo  '<h3 class="fw-year">'.'<b class="fw_title">Year:</b>' .htmlentities($row['year']).'</h3>';
                                            echo  '<h3 class="fw-sch">'.'<b class="fw_title">Society/College:</b>'.'<br>'.htmlentities($row['society']).'</h3>';
                                           
                                            echo  '<br>'; 

                                            echo '<div id="wrapper">
                                                    <div class="fw_col-40">
                                                        <button type="button" class="fw_edit">
                                                            <a style="text-decoration: none;color:white;" class=""  
                                                                href='."fellow_edit.php?value=$row[0]".' target="_blank">Edit
                                                            </a>
                                                         </button>
                                                    </div>
                                     
                                                    <div class="fw_col-45">
                                                        <button type="button" class="fw_del">
                                                            <a style="text-decoration: none;color:white;" class="" 
                                                                href='."fellow_delete.php?del=$row[0]".' target="_blank">Delete
                                                            </a>
                                                        </button>
                                                    </div>
                                                </div>';
                                ...
                                <div id="wrapper">
                                    <button type="button" class="fw_add_new" >
                                        <a style="text-decoration: none;color:white;"
                                            href="fellow_insert.php">Add New Fellowship
                                        </a>
                                    </button>
                                </div>
                            </div>
