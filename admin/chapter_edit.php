...
if (empty($_SESSION['email'])) {
  echo "<script>window.location.assign('login.php');</script>";
    ...
    if (
        isset($_POST["submit"]) && !empty($_POST["chapter_name"]) 
        && !empty($_POST["author_name"]) && !empty($_POST["book_name"])
        && !empty($_POST["page"]) && !empty($_POST["isbn"]) 
        && !empty($_POST["editor_name"]) && !empty($_POST["pub"])
      ) {
      ...
      try {
        ...
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
         ...
         $stmt = "UPDATE chapter SET chapter_name='$chapter_name ', author_name='$author_name',
         book_name='$book_name', page='$page', ISBN='$isbn', editor_name= '$editor_name',
         publisher= '$pub' WHERE chapter_id='$val'";
    ...
    <main class="container-fluid">
        <div class="row">
            ...
            <main role="main" class="ml-sm-12 col-12">
                ...
                <h3 class="heading">Edit To Chapter Contribution</h3>
                    <br>
                    <?php
                       require_once "pdo.php";
                       $stmt = $pdo->prepare("SELECT * FROM chapter where chapter_id = :val");
                       $stmt->execute(array(":val" => $_GET['value']));
                       $row = $stmt->fetch(PDO::FETCH_ASSOC);
                         $c = htmlentities($row['chapter_name']);
                         $a = htmlentities($row['author_name']);
                         $b = htmlentities($row['book_name']);
                         $pa =htmlentities($row['page']);
                         $i = htmlentities($row['ISBN']);
                         $e = htmlentities($row['editor_name']);
                    ...
                    <div class="container-chapter-insert">
                        <form action="" method="POST" class="form">
                            <div class="row">
                                ...
                                <div class="col-65">
                                  <input type="text" name="chapter_name" value="<?= $c ?>">
                                </div>
                                <br>
                                <div class="col-25">
                                ...
                                <div class="col-65">
                                  <input type="text" name="author_name" value="<?= $a ?>">
                                </div>
                                <br>
                                <div class="col-25">
                                ...
                                <div class="col-65">
                                   <input type="text" name="book_name" value="<?= $b ?>">
                                </div>
                                <br>
                                <div class="col-25">
                                ...
                                <div class="col-65">
                                  <input type="text" name="page" list="pn" value="<?= $pa ?>">
                                ...
                                <div class="col-65">
                                 <input type="text" name="isbn" list="isbnn" value="<?= $i ?>">
                                   <datalist id="isbnn" required>
                                    <option value="N/A">N/A
                                   </datalist>
                                </div>
                                <br>
                                <div class="col-25">
                                  <label for="editor-name"> Editors Name </label>
                                </div>
                                <div class="col-65">
                                    <input type="text" name="editor_name" list="editors" 
                                    value="<?= $e ?>">
                                    <datalist id="editors" required>
                                      <option value="N/A">N/A
                                    </datalist>
                                </div>
                                <br>
                                ...
                                <a href="chapter_action.php" class="cancelbtn"
