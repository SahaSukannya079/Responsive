        ...
        <main class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="ml-sm-12 col-12">
                    <div class="tm-section-wrap session_int_back_image">
                    
                    <h2 class="session_int_heading">Session Chair</h2>
                    <h3 class="session_int_head2">International Conference</h3>
                         
                        <section class="row tm-section">
                            <div id="session_int" class="section-session_int">

                                <ul class="session_int_ul">
                                    <?php
                                        require_once "pdo.php";

                                        $stmt = $pdo->query("SELECT * FROM session_inter_conf");
                                        ...
                                        $stmt = 'SELECT * FROM session_inter_conf LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
                                        ...
                                        $rows = $pdostmt->fetchAll(PDO::FETCH_BOTH);
                                         ...
                                         foreach ($rows as $row) {
                                            ...
                                            echo  '<div class="session_int">';
                                            echo  '<img src="../img/session_int_back.png" alt="scin" class="img_fluid">';
                                            echo  '<div class="session_int-content">';
                                            echo  "<h3 class='session_int-title'>".htmlentities($row['title']) .".". "<br>";
                                            echo  "<h3 class='session_int-conf'>"."<b class='bold_name'>".htmlentities($row['conf_name']) .",". "<br>";
                                            echo  "<h3 class='session_int-date'>".htmlentities($row['date']).".";
                                          
                                            echo  '<br>'; 

                                            echo '<div id="wrapper">
                                                    <div class="session_int_col-40">
                                                        <button type="button" class="session_int_edit">
                                                            <a style="text-decoration: none;color:white;" class=""  
                                                                href='."session_inter_conf_edit.php?value=$row[0]".' target="_blank">Edit
                                                            </a>
                                                         </button>
                                                    </div>
                                     
                                                    <div class="session_int_col-45">
                                                        <button type="button" class="session_int_del">
                                                            <a style="text-decoration: none;color:white;" class="" 
                                                                href='."session_inter_conf_delete.php?del=$row[0]".' target="_blank">Delete
                                                            </a>
                                                        </button>
                                                    </div>
                                                </div>';
                                ...
                                <div id="wrapper">
                                    <button type="button" class="session_int_add_new" >
                                        <a style="text-decoration: none;color:white;"
                                            href="session_inter_conf_insert.php">Add New Conference
                                        </a>
                                    </button>
                                </div>
                            </div>
                        ...
                        <?php
                            ...
                            if ($page >= 2) {
                               echo "<a href='session_inter_conf_action.php?page=" . ($page - 1) . "'> 
                               <i  class='fas'>&#xf053;</i> </a>";
                            }
