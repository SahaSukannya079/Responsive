    ...
    if (
      ...
      try {
        ...
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
         ...
         $stmt = "UPDATE scientific_nat_journal SET 
         title='$title ', author_name='$author_name',
         publication='$pub', page='$page', PMID='$pmid', DOI= '$doi'
         WHERE scientific_nat_journal_id='$val'";
         
         $conn->exec($stmt);
         
         echo "<script>window.alert('Status Changed to Available');</script>";
         echo "<script>window.location.assign('scientific_nat_jour_action.php');</script>";
        ...
        <div class="row">
            ...
            <main role="main" class="ml-sm-12 col-12">
                <div class="tm-section-wrap">
                    ...
                    <h3 class="head2"> Edit To National Journal</h3>
                    <br>
                    <?php
                       require_once "pdo.php";
                       $stmt = $pdo->prepare("SELECT * FROM scientific_nat_journal where scientific_nat_journal_id = :val");
                       ...
                       $row = $stmt->fetch(PDO::FETCH_ASSOC);
                         ...
                         $pi = htmlentities($row['PMID']);
                         $do = htmlentities($row['DOI']);
                         $val = $row['scientific_nat_journal_id']; 
                    ...
                    <div class="container-chapter-insert">
                        <form action="" method="POST" class="form">
                            <div class="row">
                                ...
                                <div class="col-65">
                                 <input type="text" name="pmid" list="pmidd" value="<?= $pi ?>">
                                ...
                                <a href="scientific_nat_jour_action.php" class="cancelbtn"
