...
if (empty($_SESSION['email'])) {
    ...
    if (
        ...
        try {
            ...
            $stmt = "insert into journal_int_journal (journal_int_journal_id,admin_id,title,official_publication,position) 
            values(' ','$admin_id','$title', '$pub', '$pos');";
            $conn->exec($stmt);

            echo "<script>window.alert('International Journal Posted to the CMS System Successful!!');</script>";
            echo "<script>window.location.assign('journal_inter_journal_action.php');</script>";
            header("Location:../journal_inter_journal.php");
            header("Location:journal_inter_journal_action.php");
