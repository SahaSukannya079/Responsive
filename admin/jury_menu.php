        ...
        <main class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="ml-sm-12 col-12">
                    <div class="tm-section-wrap jury_back_image">
                    <br>
                    <h2 class="jury_heading">Jury/Moderator/</h2>
                    <h2 class="jury_heading">Panelist/Resource Person</h2>
                    <br>
                    <br>

                    <section class="row tm-section">
                    <div id="jury" class="section-jury wb">
                        <div class="row">  
                            <div class="col-xl-6 mb-5 ">
                                <div class="jury">
                                    <img src="../img/jury1.png" alt="jurym" class="img_fluid1">
                                    <div class="jury-content">
                                    <h3 class="title-jury">International Journal</h3>
                                        <button class="btn-jury"  href="javascript:void(0);" 
                                           onclick="window.location.href='jury_inter_conf_action.php'">
                                           Click here 
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-6 mb-5">
                                <div class="jury">
                                <img src="../img/jury1.png" alt="jurym" class="img_fluid">
                                    <div class="jury-content">
                                        <h3 class="title-jury2">National Journal</h3>
                                        <br>
                                        <button class="btn-jury2"  href="javascript:void(0);" 
                                         onclick="window.location.href='jury_nat_conf_action.php'">
                                         Click here 
                                        </button>
                                    </div>
                                </div>
