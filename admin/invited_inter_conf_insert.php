...
if (empty($_SESSION['email'])) {
    ...
    if (
        ...
        try {
            ...
            $stmt = "insert into inter_conf (inter_conf_id,admin_id,title,conf_name,date) 
            values(' ','$admin_id','$title', '$conf', '$date');";
            $conn->exec($stmt);

            echo "<script>window.alert('International Conference Posted to the CMS System Successful!!');</script>";
            echo "<script>window.location.assign('invited_inter_conf_action.php');</script>";
            
            header("Location:invited_inter_conf_action.php");
        ...
        <div class="row">
            ...
            <main role="main" class="ml-sm-12 col-12">
                <div class="tm-section-wrap">
                    ...
                    <h3 class="head2">Insert To International Conference</h3>
                    <br>
                    <br>
