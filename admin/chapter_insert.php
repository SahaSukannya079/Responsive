...
if (empty($_SESSION['email'])) {
  ...
  if (
    ...
    try {
      ...
      $stmt = "insert into chapter 
      (chapter_id,admin_id,chapter_name,author_name,book_name,page,ISBN,editor_name,publisher) 
            values(' ','$admin_id','$chapter_name', '$author_name', '$book_name', '$page','$isbn', '$editor_name', '$pub');";

      $conn->exec($stmt);

      echo "<script>window.alert('Chapter Posted to the CMS System Successful!!');</script>";
      echo "<script>window.location.assign('chapter_action.php');</script>";
      header("Location:../chapter.php");
      header("Location:chapter_action.php");
        ...
        <div class="row">
            ...
            <main role="main" class="ml-sm-12 col-12">
                <div class="tm-section-wrap">
                    <h3 class="heading">Insert To Chapter Contribution</h3>
                    <br>
                    <div class="container-chapter-insert">
                        <form action="" method="POST" class="form">
                            <div class="row">
                                ...
                                <div class="col-65">
                                 <input type="text" name="isbn" list="isbnn" placeholder="Select N/A if you want to leave this field empty">
                                ...
                                <div class="col-65">
                                  <input type="text" name="pub" placeholder="Enter Publisher ">
                                </div>
                                <br>
                                <div class="sub_btn">
