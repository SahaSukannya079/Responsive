            ...
            <div class="row">
                ...
                <main role="main" class="ml-sm-12 col-12">
                    <div class="tm-section-wrap research_back_image">
                         ...
                         <h3 class="head2">Research Awards</h3>
                        ...
                        <section class="row tm-section">
                            <div id="re" class="section-re">
                                ...
                                <ul class="re_ul">
                                    ...
                                    $rows = $pdostmt->fetchAll(PDO::FETCH_BOTH);
                                         ...
                                         foreach ($rows as $row) {
                                            ...
                                            echo '<div id="wrapper">
                                                    <div class="re_col-40">
                                                        <button type="button" class="re_edit">
                                                            <a style="text-decoration: none;color:white;" class=""  
                                                                href='."researchaw_edit.php?value=$row[0]".' target="_blank">Edit
                                                            </a>
                                                         </button>
                                                    </div>
                                     
                                                    <div class="re_col-45">
                                                        <button type="button" class="re_del">
                                                            <a style="text-decoration: none;color:white;" class="" 
                                                                href='."researchaw_delete.php?del=$row[0]".' target="_blank">Delete
                                                            </a>
                                                        </button>
                                                    </div>
                                                </div>';
                                ...
                                <div id="wrapper">
                                    <button type="button" class="re_add_new" >
                                        <a style="text-decoration: none;color:white;"
                                            href="researchaw_insert.php">Add New Award
                                        </a>
                                    </button>
                                </div>
                        ...
                        <?php
                            ...
                            if ($page >= 2) {
                               echo "<a href='researchaw_action.php?page=" . ($page - 1) . "'>  
                               <i  class='fas'>&#xf053;</i> </a>";
                            }
                            echo "<a class='nice'>";
                            echo $page;
