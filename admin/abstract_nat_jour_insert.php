...
if (empty($_SESSION['email'])) {
  ...
  if (
    ...
    try {
      ...
      $stmt = "insert into abstract_nat_journal (abstract_nat_journal_id,admin_id,title,author_name,publication,page) 
      ...
      header("Location:abstract_nat_jour_action.php");
        ...
        <div class="row">
            ...
            <main role="main" class="ml-sm-12 col-12">
                <div class="tm-section-wrap">
                    ...
                    <h3 class="head2">National Journal</h3>
                    <br>
                    <br>
