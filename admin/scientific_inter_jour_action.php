        ...
        <main class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="ml-sm-12 col-12">
                    <div class="tm-section-wrap sci_int_back_image">
                         <!-- nav starts here -->
                         

                        <!-- nav ends here -->
                    <h2 class="sci_int_heading">Scientific Publications</h2>
                    <h3 class="sci_int_head2">International Journal</h3>
                    <br>

                        <?php
                        require_once "pdo.php";

                        $stmt = $pdo->query("SELECT * FROM scientific_int_journal");
                        ...
                        $stmt = 'SELECT * FROM scientific_int_journal LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
                        ...
                        foreach ($rows as $row) {
                          ...
                          echo       '<div class="w-100 tm-double-border-scin1 tm-border-color-scin">';
                          echo          '<div class="tm-double-border-scin2 tm-border-color-scin tm-box-pad-content-scin">';
                          echo             '<div class="sci_int_text_back">';
                          echo                 "<i style='font-size:24px' class='far'>&#xf044;</i> <span class='sci_int_title'>" . htmlentities($row['author_name']) . ".\t" ;
                          $mam = "Mahtab MA";
                          /*if ($row['author_name'] == $mam){
                            echo "<span class='sci_int_title'>" ."<b> htmlentities($row['author_name']) </b>";
                          }*/
                          ...
                          if ($row['title'] != "N/A") {
                            ...
                            if($lastChar == "?") {
                              echo   "<span class='sci_int_title'>" . htmlentities($row['title']) . "\t" . "</span>";
                             }else{
                                echo   "<span class='sci_int_title'>" . htmlentities($row['title']) . ".\t" . "</span>";
                             }
                           } 
                           ...
                           if ($row['page'] ==  "N/A") {
                                echo  "<b class='sci_int_bold'>" . htmlentities($row['publication']) . "</b>" . ".\t";
                            }else{
                                echo  "<b class='sci_int_bold'>" . htmlentities($row['publication']) . "</b>" . ";\t";
                            }

                          if ($row['page'] !=  "N/A") {
                            echo "<span class='sci_int_page'>" . htmlentities($row['page']) .".\t". "</span>";
                          }
                                         
                          if ($row['PMID'] !=  "N/A") {
                            echo "<span class='sci_int_pmid'><b>" . htmlentities($row['PMID']) .".\t". "</b></span>";
                          }

                          if ($row['DOI'] !=  "N/A") {
                            echo "<span class='sci_int_doi'>" . htmlentities($row['DOI']) . ".</span>";
                          }
                          ...
                          echo '<div id="wrapper">
                                 <div class="sci_int_col-40">
                                    <button type="button" class="sci_int_edit">
                                      <a style="text-decoration: none;color:white;" class=""  
                                        href='."scientific_inter_jour_edit.php?value=$row[0]".' target="_blank">Edit
                                      </a>
                                    </button>
                                    </div>
                         
                                  <div class="sci_int_col-45">
                                    <button type="button" class="sci_int_del">
                                      <a style="text-decoration: none;color:white;" class="" 
                                        href='."scientific_inter_jour_delete.php?del=$row[0]".' target="_blank">Delete
                                      </a>
                                    </button>
                                    </div>
                                  </div>';
                        ...
                        <div id="wrapper">
                            <button type="button" class="sci_int_add_new" >
                              <a style="text-decoration: none;color:white;" 
                                href="scientific_inter_jour_insert.php">Add New Journal
                              </a>
                            </button>
                        </div>
                        <br>
                        ...
                        <?php
                            ...
                            if ($page >= 2) {
                               echo "<a href='scientific_inter_jour_action.php?page=" . ($page - 1) . "'>
                               <i  class='fas'>&#xf053;</i> </a>";
                            }
