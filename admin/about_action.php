            ...
            <div class="row">
                <nav id="tmSidebar" class="tm-bg-black-transparent tm-sidebar">
                    ...
                    <div class="tm-sidebar-sticky">
                        ...
                        <div class="user">
                            ...
                            <?php echo "Logged In As: <b>" . $_SESSION["user_name"]."</b>";?>
                ...
                <main role="main" class="ml-sm-12 col-12">
                    <div class="tm-section-wrap bg-white">
                       ...
                       <h2 class="about_heading">About Professor Dr. Mamun-Al-Mahtab</h2>

                       
                       <div class="tm-section-half-about-view">
                            <div class="img">
                                <img src="../img/about_me.jpg" alt="about_me" class="img-fluid">
                            </div>
                            <ul class="about_ul">
                                <?php
                                    ...
                                    $stmt = 'SELECT * FROM about LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
                                    ...
                                    foreach ($rows as $row) {
                                        ...
                                        if ($row_counter % 2 == 0) {
                                            echo '<li class="about_li">';
                                            echo "<div class='para_div'  style='box-shadow: 0px 2px 15px rgba(121, 32, 22, 0.8); padding: 25px;'>";
                                            echo "<i style='font-size:24px' class='fas'>&#xf5fd;</i>"."\t".htmlentities($row['paragraph']);
                                            echo '<br>';
                                            echo '<br>';
                                            ...
                                            echo '<div id="wrapper">
                                                    <div class="col-40">
                                                        <button type="button" class="about_edit">
                                                            <a style="text-decoration: none;color:white;" class=""  
                                                                href='."about_edit.php?value=$row[0]".' target="_blank">Edit
                                                            </a>
                                                        </button>
                                                    </div>
                         
                                                    <div class="col-45">
                                                        <button type="button" class="about_del">
                                                            <a style="text-decoration: none;color:white;" class="" 
                                                                href='."about_delete.php?del=$row[0]".' target="_blank">Delete
                                                            </a>
                                                        </button>
                                                    </div>
                                                  </div>';
                                           ...
                                           echo '<li class="about_li">';
                                           echo "<div class='para_div'  style='box-shadow: 0px 2px 15px rgba(153, 153, 255, 0.8); padding: 25px;'>";
                                           echo "<i style='font-size:24px' class='fas'>&#xf5fd;</i>"."\t".htmlentities($row['paragraph']);
                                           echo '<br>';
                                           echo '<br>';
                           ...
                           <div id="wrapper">
                                <button type="button" class="about_add_new" >
                                    <a style="text-decoration: none;color:white;"
                                        href="about_insert.php">Add New Paragraph
                                    </a>
                                </button>
                           </div>
                        ...
                        <?php
                            ...
                            if ($page >= 2) {
                               echo "<a href='about_action.php?page=" . ($page - 1) . "'>  
                               <i  class='fas'>&#xf053;</i> </a>";
                            }
                            echo "<a class='nice'>";
                            echo $page;
