        ...
        <div class="row">
            ...
            <main role="main" class="ml-sm-12 col-12">
                <div class="tm-section-wrap">
                    ...
                    <?php
                       require_once "pdo.php";
                       $stmt = $pdo->prepare("SELECT * FROM scientific_int_journal where scientific_int_journal_id = :val");
                       ...
                       $row = $stmt->fetch(PDO::FETCH_ASSOC);
                         ...
                         $val = $row['scientific_int_journal_id']; 
                    ...
                    <div class="container-chapter-insert">
                        <form action="" method="POST" class="form">
                            <div class="row">
                                ...
                                <a href="scientific_inter_jour_action.php" class="cancelbtn"
