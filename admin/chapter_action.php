        ...
        <main class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="ml-sm-12 col-12">
                    <div class="tm-section-wrap chapter_back_image">
                   
                         <h2 class="cha_heading">Chapter Contribution</h2>
                         
                        <section class="row tm-section">
                            <div id="cha" class="section-cha">

                                <ul class="cha_ul">
                                    <?php
                                        require_once "pdo.php";

                                        $stmt = $pdo->query("SELECT * FROM chapter");
                                    ...
                                    $stmt = 'SELECT * FROM chapter LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
                                    ...
                                    $rows = $pdostmt->fetchAll(PDO::FETCH_BOTH);
                                         ...
                                         foreach ($rows as $row) {
                                            ...
                                            echo  '<div class="cha">';
                                            echo  '<img src="../img/chapter_back.png" alt="chapter" class="img_fluid">';
                                            echo  '<div class="cha-content">';
                                            echo  "<h3 class='cha-con'>"."<b class='cha_title'>Chapter Name:</b> ". htmlentities($row['chapter_name']) . "<br>";
                                            echo  "<h3 class='cha-con'>"."<b class='cha_title'>Authors Name:</b> " . htmlentities($row['author_name']) . "<br>";
                                            echo  "<h3 class='cha-con'>"."<b class='cha_title'>Book Name:</b> " . htmlentities($row['book_name']);
                                            echo "\t";
                                            if ($row['page'] != "#" && $row['page'] != "none" && $row['page'] != "N/a" && $row['page'] != "N/A") {
                                                echo "<h3 class='cha-con'>"."<b class='cha_title'>p:</b> (" . htmlentities($row['page']) . ")" . "<br>";
                                            }
                    
                                            if ($row['ISBN'] != "#" && $row['ISBN'] != "none" && $row['ISBN'] != "N/a" && $row['ISBN'] != "N/A") {
                                                echo "<h3 class='cha-con'>"."<b class='cha_title'>ISBN:</b> " . htmlentities($row['ISBN']) . "<br>";
                                            }

                                            if ($row['editor_name'] != "#" && $row['editor_name'] != "none" && $row['editor_name'] != "N/a" && $row['editor_name'] != "N/A") {
                                                echo "<h3 class='cha-con'>"."<b class='cha_title'>Eds:</b> " . htmlentities($row['editor_name']) . "<br>";
                                            }

                                            if ($row['publisher'] != "#" && $row['publisher'] != "none" && $row['publisher'] != "N/a" && $row['publisher'] != "N/A") {
                                                echo "<h3 class='cha-con'>"."<b class='cha_title'>Publisher:</b> " . htmlentities($row['publisher']) . "<br>";
                                            }
                                            ...
                                            echo '<div id="wrapper">
                                                    <div class="cha_col-40">
                                                        <button type="button" class="cha_edit">
                                                            <a style="text-decoration: none;color:white;" class=""  
                                                                href='."chapter_edit.php?value=$row[0]".' target="_blank">Edit
                                                            </a>
                                                         </button>
                                                    </div>
                                     
                                                    <div class="cha_col-45">
                                                        <button type="button" class="cha_del">
                                                            <a style="text-decoration: none;color:white;" class="" 
                                                                href='."chapter_delete.php?del=$row[0]".' target="_blank">Delete
                                                            </a>
                                                        </button>
                                                    </div>
                                                </div>';
                                ...
                                <div id="wrapper">
                                    <button type="button" class="cha_add_new" >
                                        <a style="text-decoration: none;color:white;"
                                            href="chapter_insert.php">Add New Chapter
                                        </a>
                                    </button>
                                </div>
                        ...
                        <?php
                            ...
                            if ($page >= 2) {
                               echo "<a href='chapter_action.php?page=" . ($page - 1) . "'>  
                               <i  class='fas'>&#xf053;</i> </a>";
                            }
                            echo "<a class='nice'>";
                            echo $page;
