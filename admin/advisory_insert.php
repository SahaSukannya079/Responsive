...
if (empty($_SESSION['email'])) {
  ...
  if (
    ...
    try {
      ...
      $stmt = "insert into advisory (advisory_id,admin_id,title,edition,publisher,board) 
            values(' ','$admin_id','$title', '$edition', '$pub', '$board');";
      $conn->exec($stmt);

      echo "<script>window.alert('Advisory Posted to the CMS System Successful!!');</script>";
        ...
        <div class="row">
            ...
            <main role="main" class="ml-sm-12 col-12">
                <div class="tm-section-wrap">
                    <h2 class="heading">Insert To Advisory Board Member</h2>
                    <br>
                    <br>
