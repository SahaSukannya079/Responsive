        ...
        <main class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="ml-sm-12 col-12">
                    <div class="tm-section-wrap jour_nat_back_image">
                    
                    <h2 class="jour_nat_heading">Member of Journal Editorial Boards</h2>
                    <h3 class="jour_nat_head2">National Journal</h3>
                         
                        <section class="row tm-section">
                            <div id="jour_nat" class="section-jour_nat">

                                <ul class="jour_nat_ul">
                                    <?php
                                        require_once "pdo.php";

                                        $stmt = $pdo->query("SELECT * FROM journal_nat_journal");
                                       ...
                                       $stmt = 'SELECT * FROM journal_nat_journal LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
                                       $pdostmt = $pdo->query($stmt);
                                        $rows = $pdostmt->fetchAll(PDO::FETCH_BOTH);
                                         ...
                                         foreach ($rows as $row) {
                                            ...
                                            echo  '<div class="jour_nat">';
                                            echo  '<img src="../img/jou_nat.png" alt="jounat" class="img_fluid">';
                                            echo  '<div class="jour_nat-content">';
                                            echo  "<h3 class='jour_nat-title'>".htmlentities($row['title']) . "<br>";
                                            echo  "<h3 class='jour_nat-pub'>".htmlentities($row['official_publication']) . "<br>";
                                            echo  "<h3 class='jour_nat-pos'>".htmlentities($row['position']);
                                          
                                            echo  '<br>'; 

                                            echo '<div id="wrapper">
                                                    <div class="jour_nat_col-40">
                                                        <button type="button" class="jour_nat_edit">
                                                            <a style="text-decoration: none;color:white;" class=""  
                                                                href='."journal_nat_journal_edit.php?value=$row[0]".' target="_blank">Edit
                                                            </a>
                                                         </button>
                                                    </div>
                                     
                                                    <div class="jour_nat_col-45">
                                                        <button type="button" class="jour_nat_del">
                                                            <a style="text-decoration: none;color:white;" class="" 
                                                                href='."journal_nat_journal_delete.php?del=$row[0]".' target="_blank">Delete
                                                            </a>
                                                        </button>
                                                    </div>
                                                </div>';
                                ...
                                <div id="wrapper">
                                    <button type="button" class="jour_nat_add_new" >
                                        <a style="text-decoration: none;color:white;"
                                            href="journal_nat_journal_insert.php">Add New Journal
                                        </a>
                                    </button>
                                </div>
                                <br>
                        ...
                        <?php
                            ...
                            if ($page >= 2) {
                               echo "<a href='journal_nat_journal_action.php?page=" . ($page - 1) . "'>  
                               <i  class='fas'>&#xf053;</i> </a>";
                            }
                            echo "<a class='nice'>";
                            echo $page;
