...
if (empty($_SESSION['email'])) {
    ...
    if (
        ...
        try {
            ...
            $stmt = "insert into journal_nat_journal (journal_nat_journal_id,admin_id,title,official_publication,position) 
            values(' ','$admin_id','$title', '$pub', '$pos');";
            $conn->exec($stmt);

            echo "<script>window.alert('National Journal Posted to the CMS System Successful!!');</script>";
            echo "<script>window.location.assign('journal_nat_journal_action.php');</script>";
            header("Location:../journal_nat_journal.php");
            header("Location:journal_nat_journal_action.php");
        ...
        <div class="row">
            ...
            <main role="main" class="ml-sm-12 col-12">
                <div class="tm-section-wrap">
                    ...
                    <h3 class="head2">Insert To National Journal</h3>
                    <br>
                    <br>
                    ...
                    <div class="container-insert">
                        <form action="" method="POST" class="form">
                            <div class="row">
                                ...
                                <div class="col-65">
                                    <input type="text" name="pub" placeholder="Enter Official Publication ">
                                </div>
                                <br>
                                <br>
                                <div class="col-25">
                                ...
                                <div class="col-65">
                                    <input type="text" name="pos" placeholder="Enter Position">
                                </div>
                                <br>
                                <div class="sub_btn">
