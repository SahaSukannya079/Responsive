    ...
    if (
      ...
      try {
        ...
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
         ...
         $stmt = "UPDATE journal_nat_journal SET title='$title', official_publication='$pub',
          position = '$pos' WHERE journal_nat_journal_id='$val'";
        ...
        <div class="row">
            ...
            <main role="main" class="ml-sm-12 col-12">
                <div class="tm-section-wrap">
                    ...
                    <?php
                       require_once "pdo.php";
                       $stmt = $pdo->prepare("SELECT * FROM journal_nat_journal where journal_nat_journal_id = :val");
                       ...
                       $row = $stmt->fetch(PDO::FETCH_ASSOC);
                         ...
                         $val = $row['journal_nat_journal_id']; 
                    ...
                    <div class="container-insert">
                        <form action="" method="POST" class="form">
                            <div class="row">
                                ...
                                <a href="journal_nat_journal_action.php" class="cancelbtn"
