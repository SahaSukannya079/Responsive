...
if (empty($_SESSION['email'])) {
    ...
    if (
        isset($_POST["submit"]) && !empty($_POST["title"]) && !empty($_POST["name"])
        && !empty($_POST["org"]) && !empty($_POST["date"])
    ) {
        ...
        try {
            ...
            $stmt = "insert into socio (socio_id,admin_id,title,name,organized,date) 
            values(' ', '$admin_id', '$title',  '$name',  '$org', '$date');";
            $conn->exec($stmt);

            echo "<script>window.alert('Socio-Political Activities Posted to the CMS System Successful!!');</script>";
            echo "<script>window.location.assign('socio_political_action.php');</script>";
            
            header("Location:socio_political_action.php");
        ...
        <div class="row">
            ...
            <main role="main" class="ml-sm-12 col-12">
                <div class="tm-section-wrap">
                    <h2 class="heading">Socio-Political Activities  </h2>
                    <h3 class="head2">Insert To Socio-Political Activities</h3>
                    <br>
                    <br>
                    ...
                    <div class="container-insert">
                        <form action="" method="POST" class="form">
                            <div class="row">
                                ...
                                <div class="col-65">
                                    <input type="text" name="title" list="n" placeholder="Enter Title">
                                    <datalist id="n" required>
                                ...
                                <div class="col-65">
                                    <input type="text" name="name" list="pn"  
                                ...
                                <div class="col-65">
                                    <input type="text" name="org" list="or" placeholder="Enter Organization ">
                                    <datalist id="or" required>
                                       <option value="N/A">N/A
                                    </datalist>
                                </div>
                                <br>
                                ...
                                <div class="col-65">
                                    <input type="text" name="date" list="d" placeholder="Enter Date ">
                                    <datalist id="d" required>
                                       <option value="N/A">N/A
                                    </datalist>
                                </div>
                                <br>
