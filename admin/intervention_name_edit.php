        ...
        ) 
    {
      ...
      try {
        ...
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
         ...
         $stmt = "UPDATE intervention SET intervention_type='$inv_type', description ='$des',
           intervention_name = '$inv_name' WHERE intervention_id='$val'";
...
<!--<li class="nav-item">
            ...
            <main role="main" class="ml-sm-12 col-12">
                <div class="tm-section-wrap">
                    <h2 class="heading">Edit To Intervention</h2>
                    <br>
                    <br>

                    <?php
                       require_once "pdo.php";
                       $stmt = $pdo->prepare("SELECT * FROM intervention where intervention_id = :val");
                       $stmt->execute(array(":val" => $_GET['value']));
                       $row = $stmt->fetch(PDO::FETCH_ASSOC);
                         $t = htmlentities($row['intervention_type']);
                         $d = htmlentities($row['description']);
                         $n = htmlentities($row['intervention_name']);
                         $val = $row['intervention_id']; 
                    ...
                    <div class="container-insert">
                        <form action="" method="POST" class="form">
                             <div class="row">
                                ...
                                <div class="col-65">
                                  <input type="text" name="inv_type" list="inv" value="<?= $t ?> ">
                                </div>
                                <div class="col-25">
                                     <label for="des"> Description </label>
                                </div>
                                <div class="col-65">
                                    <input type="text" name="des" value="<?= $d ?>">
                                </div>
                                <br>
                                <div class="col-25">
                                ...
                                <div class="col-65">
                                    <input type="text" name="inv_name"  list="inv_name" 
                                    value="<?= $n ?>">
                                ...
                                <a href="intervention_action.php" class="cancelbtn"
