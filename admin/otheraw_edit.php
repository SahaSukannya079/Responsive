        ...
        && !empty($_POST["scholarship"]) && !empty($_POST["abody"])) 
    {
      ...
      try {
        ...
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
         ...
         $stmt = "UPDATE otheraw SET year='$year', scholarship='$scholarship',
          abody= '$abody' WHERE otheraw_id='$val'";
        ...
        <div class="row">
            ...
            <main role="main" class="ml-sm-12 col-12">
                <div class="tm-section-wrap">
                    ...
                    <h3 class="head2"> Edit To Other Awards</h3>
                    <br>
                    <br>
                    <?php
                       require_once "pdo.php";
                       $stmt = $pdo->prepare("SELECT * FROM otheraw where otheraw_id = :val");
                        ...
                        <form action="" method="POST" class="form">
                            <div class="row">
                               <div class="col-25">
                                ...
                                <a href="otheraw_action.php" class="cancelbtn"
