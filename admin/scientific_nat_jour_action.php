                ...
                <main role="main" class="ml-sm-12 col-12">
                    <div class="tm-section-wrap sci_nat_back_image">
                        ...
                        foreach ($rows as $row) {
                          ...
                          echo '<div id="wrapper">
                          <div class="me_col-40">
                             <button type="button" class="sci_nat_edit">
                               <a style="text-decoration: none;color:white;" class=""  
                                 href='."scientific_nat_jour_edit.php?value=$row[0]".' target="_blank">Edit
                               </a>
                             </button>
                             </div>
                  
                           <div class="me_col-45">
                             <button type="button" class="sci_nat_del">
                               <a style="text-decoration: none;color:white;" class="" 
                                 href='."scientific_nat_jour_delete.php?del=$row[0]".' target="_blank">Delete
                               </a>
                             </button>
                             </div>
                           </div>';
                        ...
                        <div id="wrapper">
                            <button type="button" class="sc_add_new" >
                                <a style="text-decoration: none;color:white;"
                                    href="scientific_nat_jour_insert.php">Add New Activities
                                 </a>
                             </button>
                        </div>
                        <br>
                        ...
                        <?php
                            ...
                            if ($page >= 2) {
                               echo "<a href='scientific_nat_jour_action.php?page=" . ($page - 1) . "'>
                               <i  class='fas'>&#xf053;</i> </a>";
                            }
