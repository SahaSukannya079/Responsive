        ...
        <main class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="ml-sm-12 col-12">
                    <div class="tm-section-wrap organizing_back_image">
                    <h2 class="organizing_heading">Organizing Experience</h2>
                    <br>
                    <br>

                    
                    <section class="row tm-section">
                      <div id="organizing" class="section-organizing">
                        <div class="row">  
                            <div class="col-xl-6 mb-5">
                                <div class="organizing">
                                    <img src="../img/org_back.png" alt="org" class="img_fluid">
                                    <div class="organizing-content">
                                    <h3 class="title-organizing">International</h3>
                                        <button class="btn"  href="javascript:void(0);" 
                                           onclick="window.location.href='organize_int_action.php'">
                                           Click here 
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-6 mb-5 column">
                                <div class="organizing">
                                    <img src="../img/org_back.png" alt="org" class="img_fluid">
                                    <div class="organizing-content">
                                    <h3 class="title-organizing2">National</h3>
                                        <button class="btn"  href="javascript:void(0);" 
                                           onclick="window.location.href='organize_nat_action.php'">
                                           Click here 
                                        </button>
                                    </div>
                                </div>
