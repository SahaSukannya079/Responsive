...
if (empty($_SESSION['email'])) {
  echo "<script>window.location.assign('login.php');</script>";
    ...
    if (isset($_POST["submit"]) && !empty($_POST["book_name"])
        && !empty($_POST["isbn"]) && !empty($_POST["author_name"])
        && !empty($_POST["pub"])){
      ...
      try {
        ...
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
         ...
         $stmt = "UPDATE books_edited SET book_name='$book_name', ISBN='$isbn',
          author_name= '$author_name', publisher= '$pub' WHERE book_id='$val'";
         
         $conn->exec($stmt);
         
         echo "<script>window.alert('Status Changed to Available');</script>";
         echo "<script>window.location.assign('book_edited_action.php');</script>";
        ...
        <div class="row">
            ...
            <main role="main" class="ml-sm-12 col-12">
                <div class="tm-section-wrap">
                    <h2 class="heading">Edit To Books Edited</h2>
                    <br>
                    <br>
                    <?php
                       require_once "pdo.php";
                       $stmt = $pdo->prepare("SELECT * FROM books_edited where book_id = :val");
                    ...
                    <div class="container-insert">
                        <form action="" method="POST" class="form">
                            <div class="row">
                                ...
                                <div class="col-65">
                                    <input type="text" name="isbn" value="<?= $i ?>">
                                </div>
                                <br>
                                <div class="col-25">
                                ...
                                <a href="book_edited_action.php" class="cancelbtn"
