        ...
        <main class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="ml-sm-12 col-12">
                    <div class="tm-section-wrap abstract_nat_back_image">
                    
                    <h2 class="abstract_nat_heading">Abstracts</h2>
                    <h3 class="abstract_nat_head2">National Journal</h3>

                        <?php
                        require_once "pdo.php";

                        $stmt = $pdo->query("SELECT * FROM abstract_nat_journal");
                        ...
                        $stmt = 'SELECT * FROM abstract_nat_journal LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
                        ...
                        foreach ($rows as $row) {
                          ...
                          echo             '<div class="abstract_nat_text_back">';
                          ...
                          echo '<div id="wrapper">
                                 <div class="abstract_nat_col-40">
                                    <button type="button" class="abstract_nat_edit">
                                      <a style="text-decoration: none;color:white;" class=""  
                                        href='."abstract_nat_jour_edit.php?value=$row[0]".' target="_blank">Edit
                                      </a>
                                    </button>
                                    </div>
                         
                                  <div class="abstract_nat_col-45">
                                    <button type="button" class="abstract_nat_del">
                                      <a style="text-decoration: none;color:white;" class="" 
                                        href='."abstract_nat_jour_delete.php?del=$row[0]".' target="_blank">Delete
                                      </a>
                                    </button>
                                    </div>
                                  </div>';
                        ...
                        <div id="wrapper">
                            <button type="button" class="abstract_nat_add_new" >
                              <a style="text-decoration: none;color:white;" 
                                href="abstract_nat_jour_insert.php">Add New Journal
                              </a>
                            </button>
                        </div>
                        <br>
                        ...
                        <?php
                            ...
                            if ($page >= 2) {
                               echo "<a href='abstract_nat_jour_action.php?page=" . ($page - 1) . "'>  
                               <i  class='fas'>&#xf053;</i>  </a>";
                            }
                            echo "<a class='nice'>";
                            echo $page;
