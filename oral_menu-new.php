        ...
        <main class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="ml-sm-12 col-12">
                    <div class="tm-section-wrap oral_back_image">
                        <h2 class="oral_heading">Oral Presentations</h2>
                       <br><br><br>

                        <section class="row tm-section">
                            <div id="oral" class="section-oral">
                                <div class="con">
                                    <div class="row">
                                        <div class="col-md-6 ">
                                            <div class="oral">
                                                <img src="img/ms1.png" alt="oral" class="img_fluid">
                                                    <div class="oral-content">
                                                       <h3 class="title-oral">International Conferences</h3>
                                                         <button class="btn-oral"  href="javascript:void(0);" 
                                                         onclick="window.location.href='oral_inter_conf.php'">
                                                          Click here 
                                                        </button>
                                                    </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="oral">
                                                <img src="img/ms2.png" alt="oral" class="img_fluid">
                                                    <div class="oral-content">
                                                        <h3 class="title-oral2">National Conferences</h3>
                                                        
                                                        <button class="btn1-oral"  href="javascript:void(0);" 
                                                          onclick="window.location.href='oral_nat_conf.php'">
                                                         Click here 
                                                        </button>
                                                    </div>
                                            </div>
