            ...
            <div class="row">
                <nav id="tmSidebar" class="tm-bg-black-transparent tm-sidebar">
                    ...
                    <div class="tm-brand-box">
                            <img src="img/rez_logo.png" alt="about_me" class="menu-img"> 
                        </div>
                        ...
                        <ul id="tmMainNav" class="nav flex-column text-uppercase text-right tm-main-nav">
                            ...
                            <li class="nav-item">
                                <a href="javascript:void(0);" 
                                onclick="window.location.href='working_party.php'" 
                                class="nav-link">
                                    <span class="rect"></span>
                                    <span class="circle"></span>
                            ...
                            <li class="nav-item">
                                <a href="javascript:void(0);" 
                                onclick="window.location.href='socio_political.php'" 
                                class="nav-link">
                                    <span class="rect"></span>
                                    <span class="circle"></span>
                            ...
                            <li class="nav-item">
                                <a href="javascript:void(0);" 
                                onclick="window.location.href='media.php'" 
                                class="nav-link">
                                    <span class="rect"></span>
                                    <span class="circle"></span>
                                    Presence in Media
                ...
                <main role="main" class="ml-sm-12 col-12">
                    <div class="tm-section-wrap abstract_back_image">
                    
                    <h2 class="abstract_heading">Abstracts</h2>
                    
                    <section class="row tm-section">
                    <div id="abstract" class="section-abstract wb">
                        <div id="abstract" class="section-abstract">
                        <div class="row">  
                            <div class="col-xl-6 mb-5">
                                <div class="abstract">
                                    <img src="img/abs_back.png" alt="abmenu1" class="img_fluid">
                                    <div class="abstract-content">
                                    <h3 class="title-abstract">International Journal</h3>
                                        <button class="btn"  href="javascript:void(0);" 
                                           onclick="window.location.href='abstract_inter_jour.php'">
                                           Click here 
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-6  mb-5 column">
                                ...
                                <img src="img/abs_back.png" alt="abmenu1" class="img_fluid">
                                    <div class="abstract-content">
                                        <h3 class="title-abstract">National Journal</h3>
                                        <br>
                                        <button class="btn"  href="javascript:void(0);" 
                                         onclick="window.location.href='abstract_nat_jour.php'">
                                         Click here 
                                        </button>
                                    </div>
                                </div>
