                ...
                <main role="main" class="ml-sm-12 col-12">
                    ...
                    <br>
                        ...
                        foreach ($rows as $row) {
                          ...
                          /*echo                 "<i style='font-size:24px' class='far'>&#xf044;</i> <span class='sci_int_title'><b>" . htmlentities($row['scientific_int_journal_id']) . "</b>.\t" ;*/
                        ...
                        if ($page >= 2) {
                           echo "<a href='scientific_inter_jour.php?page=" . ($page - 1) . "'>  
                           <i  class='fas'>&#xf053;</i></a>";
                        }
                        echo "<a class='nice'>";
                        echo $page;
