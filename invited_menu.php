                    ...
                    <div id="invited" class="section-invited wb">
                        <div class="row">  
                            <div class="col-xl-6 mb-5 ">
                                <div class="invited">
                                    <img src="img/speaker.png" alt="inv" class="img_fluid1">
                                    ...
                                    <h3 class="title-invited">International Conferences</h3>
                                        <button class="btn-invited"  href="javascript:void(0);" 
                                           onclick="window.location.href='invited_inter_conf.php'">
                                           Click here 
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-6 mb-5 column">
                                <div class="invited">
                                <img src="img/speaker.png" alt="inv" class="img_fluid">
                                    <div class="invited-content">
                                        <h3 class="title-invited2">National Conferences</h3>
                                        <br>
                                        <button class="btn-invited2"  href="javascript:void(0);" 
                                         onclick="window.location.href='invited_nat_conf.php'">
                                         Click here 
                                        </button>
                                    </div>
                                </div>
